...
@Component({
  selector: 'ConfigurablePivotHeatmap-component',
  templateUrl: './ConfigurablePivotHeatmap.html',
  styles: [``]
})
export class ConfigurablePivotHeatmapComponent implements OnInit {
...
mainCtnReady = function(event) {
    console.log("mainCtnReady ready");
    this.mainCtn = event.ext;
}
