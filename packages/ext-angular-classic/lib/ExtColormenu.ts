...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtColormenuComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtColormenuComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCColormenu()).eventnames;
//var eventnamesall = [];
