...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtDesktopComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtDesktopComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCDesktop()).eventnames;
//var eventnamesall = [];
