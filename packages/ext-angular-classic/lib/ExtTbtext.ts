...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtTbtextComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtTbtextComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCTbtext()).eventnames;
//var eventnamesall = [];
