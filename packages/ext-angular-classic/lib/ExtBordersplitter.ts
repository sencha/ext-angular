...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtBordersplitterComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtBordersplitterComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCBordersplitter()).eventnames;
//var eventnamesall = [];
