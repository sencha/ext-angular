...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtColorpickerslideralphaComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtColorpickerslideralphaComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCColorpickerslideralpha()).events,
