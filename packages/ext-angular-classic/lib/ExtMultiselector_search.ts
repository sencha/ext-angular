...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtMultiselector_searchComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtMultiselector_searchComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCMultiselector_search()).events,
...
//var events = (new EWCMultiselector_search()).eventnames;
//var eventnamesall = [];
