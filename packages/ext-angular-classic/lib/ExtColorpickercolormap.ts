...
@Component({
    selector: 'ExtColorpickercolormap',
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtColorpickercolormapComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtColorpickercolormapComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCColorpickercolormap()).events,
...
//var events = (new EWCColorpickercolormap()).eventnames;
//var eventnamesall = [];
