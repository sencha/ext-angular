...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtTbfillComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtTbfillComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCTbfill()).eventnames;
//var eventnamesall = [];
