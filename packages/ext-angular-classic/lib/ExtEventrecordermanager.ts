...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtEventrecordermanagerComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtEventrecordermanagerComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCEventrecordermanager()).events,
