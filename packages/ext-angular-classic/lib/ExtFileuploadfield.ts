...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtFileuploadfieldComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtFileuploadfieldComponent extends EngBase {
    constructor(
        eRef: ElementRef,
