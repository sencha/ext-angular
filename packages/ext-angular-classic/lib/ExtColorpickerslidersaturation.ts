...
@Component({
    selector: 'ExtColorpickerslidersaturation',
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtColorpickerslidersaturationComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtColorpickerslidersaturationComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCColorpickerslidersaturation()).events,
...
//var events = (new EWCColorpickerslidersaturation()).eventnames;
//var eventnamesall = [];
