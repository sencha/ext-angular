...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtRoweditorbuttonsComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtRoweditorbuttonsComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCRoweditorbuttons()).events,
...
//var events = (new EWCRoweditorbuttons()).eventnames;
//var eventnamesall = [];
