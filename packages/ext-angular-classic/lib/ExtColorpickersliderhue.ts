...
@Component({
    selector: 'ExtColorpickersliderhue',
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtColorpickersliderhueComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtColorpickersliderhueComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCColorpickersliderhue()).events,
...
//var events = (new EWCColorpickersliderhue()).eventnames;
//var eventnamesall = [];
