...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtTriggerfieldComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtTriggerfieldComponent extends EngBase {
    constructor(
        eRef: ElementRef,
