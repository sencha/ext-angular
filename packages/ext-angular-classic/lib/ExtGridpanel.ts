...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtGridpanelComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtGridpanelComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCGridpanel()).eventnames;
//var eventnamesall = [];
