...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtExplorerComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtExplorerComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCExplorer()).eventnames;
//var eventnamesall = [];
