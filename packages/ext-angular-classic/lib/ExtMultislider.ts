...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtMultisliderComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtMultisliderComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCMultislider()).events,
            ['ready','activate','added','afterlayoutanimation','afterrender','beforeactivate','beforechange','beforedeactivate','beforedestroy','beforehide','beforerender','beforeshow','beforestaterestore','beforestatesave','blur','boxready','change','changecomplete','deactivate','destroy','dirtychange','disable','drag','dragend','dragstart','enable','errorchange','focus','focusenter','focusleave','hide','move','removed','render','resize','show','specialkey','staterestore','statesave','validitychange','writeablechange',],
            vc
        )
