...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtTbspacerComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtTbspacerComponent extends EngBase {
    constructor(
        eRef: ElementRef,
...
//var events = (new EWCTbspacer()).eventnames;
//var eventnamesall = [];
