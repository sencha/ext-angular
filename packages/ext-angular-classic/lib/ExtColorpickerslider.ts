//import EWCColorpickerslider from '../dist/ext-colorpickerslider.component.js';
//inputs: (new EWCColorpickerslider()).properties,
//import EWCColorpickerslider from '@sencha/ext-web-components-classic/dist/ext-colorpickerslider.component.js';
import { EWCColorpickerslider } from '@sencha/ext-web-components-classic';
import {
    Host,
    Optional,
    SkipSelf,
...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtColorpickersliderComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtColorpickersliderComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCColorpickerslider()).events,
...
//var events = (new EWCColorpickerslider()).eventnames;
//var eventnamesall = [];
