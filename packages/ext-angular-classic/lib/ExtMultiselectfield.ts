...
@Component({
    ...
    providers: [{provide: EngBase, useExisting: forwardRef(() => ExtMultiselectfieldComponent)}],
    template: '<ng-content></ng-content>'
})
export class ExtMultiselectfieldComponent extends EngBase {
    constructor(
        eRef: ElementRef,
        ...
        super(
            ...
            (new EWCMultiselectfield()).events,
