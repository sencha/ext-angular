...
export class dragcolumnMetaData {
  public static XTYPE: string = 'dragcolumn';
...
@Component({
  ...
  providers: [{provide: base, useExisting: forwardRef(() => ExtDragcolumnComponent)}],
  template: '<ng-template></ng-template>'
})
export class ExtDragcolumnComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(
