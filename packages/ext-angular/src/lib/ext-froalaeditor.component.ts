...
export class froalaeditorMetaData {
  public static XTYPE: string = 'froalaeditor';
...
@Component({
  ...
  providers: [{provide: base, useExisting: forwardRef(() => ExtFroalaeditorComponent)}],
  template: '<ng-template></ng-template>'
})
export class ExtFroalaeditorComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(
