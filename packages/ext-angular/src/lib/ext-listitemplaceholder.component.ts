...
export class listitemplaceholderMetaData {
  public static XTYPE: string = 'listitemplaceholder';
...
@Component({
  ...
  providers: [{provide: base, useExisting: forwardRef(() => ExtListitemplaceholderComponent)}],
  template: '<ng-template></ng-template>'
})
export class ExtListitemplaceholderComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(
