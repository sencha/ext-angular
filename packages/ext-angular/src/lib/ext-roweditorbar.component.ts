...
@Component({
  ...
  providers: [{provide: base, useExisting: forwardRef(() => ExtRoweditorbarComponent)}],
  template: '<ng-template></ng-template>'
})
export class ExtRoweditorbarComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(
