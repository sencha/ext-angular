...
export class roweditorcellMetaData {
  public static XTYPE: string = 'roweditorcell';
...
@Component({
  ...
  providers: [{provide: base, useExisting: forwardRef(() => ExtRoweditorcellComponent)}],
  template: '<ng-template></ng-template>'
})
export class ExtRoweditorcellComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(
