...
export class ExtExpandtriggerComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,expandtriggerMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(expandtriggerMetaData)}
