...
export class roweditorgapMetaData {
  public static XTYPE: string = 'roweditorgap';
...
@Component({
  ...
  providers: [{provide: base, useExisting: forwardRef(() => ExtRoweditorgapComponent)}],
  template: '<ng-template></ng-template>'
})
export class ExtRoweditorgapComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(
