//import EWCListswiperitem from '../dist/ext-listswiperitem.component.js';
//inputs: (new EWCListswiperitem()).properties,
import EWCListswiperitem from '@sencha/ext-web-components/dist/ext-listswiperitem.component.js';
import {
    Host,
    Optional,
    SkipSelf,
