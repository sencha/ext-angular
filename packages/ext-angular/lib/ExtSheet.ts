//import EWCSheet from '../dist/ext-sheet.component.js';
//inputs: (new EWCSheet()).properties,
import EWCSheet from '@sencha/ext-web-components/dist/ext-sheet.component.js';
import {
    Host,
    Optional,
    SkipSelf,
