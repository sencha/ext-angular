//import EWCGroupcontainer from '../dist/ext-groupcontainer.component.js';
//inputs: (new EWCGroupcontainer()).properties,
import EWCGroupcontainer from '@sencha/ext-web-components/dist/ext-groupcontainer.component.js';
import {
    Host,
    Optional,
    SkipSelf,
