//import EWCSpinuptrigger from '../dist/ext-spinuptrigger.component.js';
//inputs: (new EWCSpinuptrigger()).properties,
import EWCSpinuptrigger from '@sencha/ext-web-components/dist/ext-spinuptrigger.component.js';
import {
    Host,
    Optional,
    SkipSelf,
