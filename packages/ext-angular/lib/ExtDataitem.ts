//import EWCDataitem from '../dist/ext-dataitem.component.js';
//inputs: (new EWCDataitem()).properties,
import EWCDataitem from '@sencha/ext-web-components/dist/ext-dataitem.component.js';
import {
    Host,
    Optional,
    SkipSelf,
