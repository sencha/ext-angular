//import EWCGridrow from '../dist/ext-gridrow.component.js';
//inputs: (new EWCGridrow()).properties,
import EWCGridrow from '@sencha/ext-web-components/dist/ext-gridrow.component.js';
import {
    Host,
    Optional,
    SkipSelf,
