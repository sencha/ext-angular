//import EWCSpacer from '../dist/ext-spacer.component.js';
//inputs: (new EWCSpacer()).properties,
import EWCSpacer from '@sencha/ext-web-components/dist/ext-spacer.component.js';
import {
    Host,
    Optional,
    SkipSelf,
