//import EWCContainerfield from '../dist/ext-containerfield.component.js';
//inputs: (new EWCContainerfield()).properties,
import EWCContainerfield from '@sencha/ext-web-components/dist/ext-containerfield.component.js';
import {
    Host,
    Optional,
    SkipSelf,
