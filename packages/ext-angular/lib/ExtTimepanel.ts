//import EWCTimepanel from '../dist/ext-timepanel.component.js';
//inputs: (new EWCTimepanel()).properties,
import EWCTimepanel from '@sencha/ext-web-components/dist/ext-timepanel.component.js';
import {
    Host,
    Optional,
    SkipSelf,
