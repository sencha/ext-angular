//import EWCMedia from '../dist/ext-media.component.js';
//inputs: (new EWCMedia()).properties,
import EWCMedia from '@sencha/ext-web-components/dist/ext-media.component.js';
import {
    Host,
    Optional,
    SkipSelf,
