//import EWCPullrefreshbar from '../dist/ext-pullrefreshbar.component.js';
//inputs: (new EWCPullrefreshbar()).properties,
import EWCPullrefreshbar from '@sencha/ext-web-components/dist/ext-pullrefreshbar.component.js';
import {
    Host,
    Optional,
    SkipSelf,
