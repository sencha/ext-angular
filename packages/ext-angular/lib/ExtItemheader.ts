//import EWCItemheader from '../dist/ext-itemheader.component.js';
//inputs: (new EWCItemheader()).properties,
import EWCItemheader from '@sencha/ext-web-components/dist/ext-itemheader.component.js';
import {
    Host,
    Optional,
    SkipSelf,
