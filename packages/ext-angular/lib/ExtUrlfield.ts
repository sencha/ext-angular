//import EWCUrlfield from '../dist/ext-urlfield.component.js';
//inputs: (new EWCUrlfield()).properties,
import EWCUrlfield from '@sencha/ext-web-components/dist/ext-urlfield.component.js';
import {
    Host,
    Optional,
    SkipSelf,
