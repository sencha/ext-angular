//import EWCPivotrangeeditor from '../dist/ext-pivotrangeeditor.component.js';
//inputs: (new EWCPivotrangeeditor()).properties,
import EWCPivotrangeeditor from '@sencha/ext-web-components/dist/ext-pivotrangeeditor.component.js';
import {
    Host,
    Optional,
    SkipSelf,
...
export class ExtPivotrangeeditorComponent extends EngBase {
    constructor(
        ...
        super(
            ...
            (new EWCPivotrangeeditor()).events,
