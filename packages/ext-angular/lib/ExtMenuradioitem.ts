//import EWCMenuradioitem from '../dist/ext-menuradioitem.component.js';
//inputs: (new EWCMenuradioitem()).properties,
import EWCMenuradioitem from '@sencha/ext-web-components/dist/ext-menuradioitem.component.js';
import {
    Host,
    Optional,
    SkipSelf,
