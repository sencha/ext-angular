//import EWCTabletpicker from '../dist/ext-tabletpicker.component.js';
//inputs: (new EWCTabletpicker()).properties,
import EWCTabletpicker from '@sencha/ext-web-components/dist/ext-tabletpicker.component.js';
import {
    Host,
    Optional,
    SkipSelf,
