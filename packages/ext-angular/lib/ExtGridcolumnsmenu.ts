//import EWCGridcolumnsmenu from '../dist/ext-gridcolumnsmenu.component.js';
//inputs: (new EWCGridcolumnsmenu()).properties,
import EWCGridcolumnsmenu from '@sencha/ext-web-components/dist/ext-gridcolumnsmenu.component.js';
import {
    Host,
    Optional,
    SkipSelf,
