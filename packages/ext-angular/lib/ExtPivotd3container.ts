...
@Component({
    ...
    inputs: ['label','fitToParent','tab','config','platformConfig','extname','viewport','align','plugins','responsiveConfig','responsiveFormulas','configurator','drawing','matrix',],
    outputs: ['ready',],
...
export class ExtPivotd3containerComponent extends EngBase {
    constructor(
        ...
        super(
            eRef,
            hostComponent,
            ['label','fitToParent','tab','config','platformConfig','extname','viewport','align','plugins','responsiveConfig','responsiveFormulas','configurator','drawing','matrix',],
