//import EWCRowheader from '../dist/ext-rowheader.component.js';
//inputs: (new EWCRowheader()).properties,
import EWCRowheader from '@sencha/ext-web-components/dist/ext-rowheader.component.js';
import {
    Host,
    Optional,
    SkipSelf,
