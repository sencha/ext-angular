//import EWCSinglesliderfield from '../dist/ext-singlesliderfield.component.js';
//inputs: (new EWCSinglesliderfield()).properties,
import EWCSinglesliderfield from '@sencha/ext-web-components/dist/ext-singlesliderfield.component.js';
import {
    Host,
    Optional,
    SkipSelf,
...
export class ExtSinglesliderfieldComponent extends EngBase {
    constructor(
        ...
        super(
            ...
            (new EWCSinglesliderfield()).events,
