//import EWCTextcolumn from '../dist/ext-textcolumn.component.js';
//inputs: (new EWCTextcolumn()).properties,
import EWCTextcolumn from '@sencha/ext-web-components/dist/ext-textcolumn.component.js';
import {
    Host,
    Optional,
    SkipSelf,
