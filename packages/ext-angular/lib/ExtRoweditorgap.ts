//import EWCRoweditorgap from '../dist/ext-roweditorgap.component.js';
//inputs: (new EWCRoweditorgap()).properties,
import EWCRoweditorgap from '@sencha/ext-web-components/dist/ext-roweditorgap.component.js';
import {
    Host,
    Optional,
    SkipSelf,
