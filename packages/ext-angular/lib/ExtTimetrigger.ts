//import EWCTimetrigger from '../dist/ext-timetrigger.component.js';
//inputs: (new EWCTimetrigger()).properties,
import EWCTimetrigger from '@sencha/ext-web-components/dist/ext-timetrigger.component.js';
import {
    Host,
    Optional,
    SkipSelf,
