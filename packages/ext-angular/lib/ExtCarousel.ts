//import EWCCarousel from '../dist/ext-carousel.component.js';
//inputs: (new EWCCarousel()).properties,
import EWCCarousel from '@sencha/ext-web-components/dist/ext-carousel.component.js';
import {
    Host,
    Optional,
    SkipSelf,
