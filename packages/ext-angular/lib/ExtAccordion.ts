//import EWCAccordion from '../dist/ext-accordion.component.js';
//inputs: (new EWCAccordion()).properties,
import EWCAccordion from '@sencha/ext-web-components/dist/ext-accordion.component.js';
import {
    Host,
    Optional,
    SkipSelf,
