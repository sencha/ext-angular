//import EWCActionsheet from '../dist/ext-actionsheet.component.js';
//inputs: (new EWCActionsheet()).properties,
import EWCActionsheet from '@sencha/ext-web-components/dist/ext-actionsheet.component.js';
import {
    Host,
    Optional,
    SkipSelf,
