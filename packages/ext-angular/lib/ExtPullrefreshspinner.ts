//import EWCPullrefreshspinner from '../dist/ext-pullrefreshspinner.component.js';
//inputs: (new EWCPullrefreshspinner()).properties,
import EWCPullrefreshspinner from '@sencha/ext-web-components/dist/ext-pullrefreshspinner.component.js';
import {
    Host,
    Optional,
    SkipSelf,
...
export class ExtPullrefreshspinnerComponent extends EngBase {
    constructor(
        ...
        super(
            ...
            (new EWCPullrefreshspinner()).events,
