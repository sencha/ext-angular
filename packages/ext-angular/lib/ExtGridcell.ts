//import EWCGridcell from '../dist/ext-gridcell.component.js';
//inputs: (new EWCGridcell()).properties,
import EWCGridcell from '@sencha/ext-web-components/dist/ext-gridcell.component.js';
import {
    Host,
    Optional,
    SkipSelf,
