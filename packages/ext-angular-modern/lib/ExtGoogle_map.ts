//import EWCGoogle_map from '../dist/ext-google-map.component.js';
//inputs: (new EWCGoogle_map()).properties,
//import EWCGoogle_map from '@sencha/ext-web-components-modern/dist/ext-google-map.component.js';
import { EWCGoogle_map } from '@sencha/ext-web-components-modern';
import {
    Host,
    Optional,
    SkipSelf,
