//import EWCPaneltool from '../dist/ext-paneltool.component.js';
//inputs: (new EWCPaneltool()).properties,
//import EWCPaneltool from '@sencha/ext-web-components-modern/dist/ext-paneltool.component.js';
import { EWCPaneltool } from '@sencha/ext-web-components-modern';
import {
    Host,
    Optional,
    SkipSelf,
