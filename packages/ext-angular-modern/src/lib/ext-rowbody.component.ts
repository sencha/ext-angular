...
export class rowbodyMetaData {
  public static XTYPE: string = 'rowbody';
...
export class ExtRowbodyComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,rowbodyMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(rowbodyMetaData)}
