...
export class ExtPivotgridcellComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,pivotgridcellMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(pivotgridcellMetaData)}
