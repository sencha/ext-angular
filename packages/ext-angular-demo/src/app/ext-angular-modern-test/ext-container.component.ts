...
export class ExtContainerComponent extends base implements 
  OnInit,
  AfterContentInit,
  //AfterContentChecked, 
  AfterViewInit
  ...
  //OnChanges 
{
  ...
  constructor(eRef:ElementRef,@Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef,containerMetaData, hostComponent)}
  ...
  public ngAfterContentInit() {this.baseAfterContentInit()} //this['ready'].emit(this)
  //public ngAfterContentChecked() {console.log(this)} 
  public ngAfterViewInit() {console.log(this.ext)} 
  //public ngAfterViewChecked() {console.log(this)} 
}