...
export class ExtTimetriggerComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,timetriggerMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(timetriggerMetaData)}
