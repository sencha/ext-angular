...
export class ExtFormpanelComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,formpanelMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(formpanelMetaData)}
