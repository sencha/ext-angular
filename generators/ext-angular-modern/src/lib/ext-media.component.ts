...
export class ExtMediaComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,mediaMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(mediaMetaData)}
