...
export class ExtSimplelistitemComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,simplelistitemMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(simplelistitemMetaData)}
