...
export class ExtDatetriggerComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,datetriggerMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(datetriggerMetaData)}
