...
export class ExtRownumberercellComponent extends base implements OnInit,AfterContentInit,OnChanges {
  constructor(eRef:ElementRef, @Host() @Optional() @SkipSelf() public hostComponent : base) {super(eRef.nativeElement,rownumberercellMetaData,hostComponent)}
  ...
  public ngOnInit() {this.baseOnInit(rownumberercellMetaData)}
