(function () {
class ExtFieldset extends ExtBase {
	...
	get instructions(){return this.getAttribute('instructions')};set instructions(instructions){this.setAttribute('instructions',instructions)}
