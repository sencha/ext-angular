(function () {
class ExtFilebutton extends ExtBase {
	...
	get arrow(){return this.getAttribute('arrow')};set arrow(arrow){this.setAttribute('arrow',arrow)}
	get arrowAlign(){return this.getAttribute('arrowAlign')};set arrowAlign(arrowAlign){this.setAttribute('arrowAlign',arrowAlign)}
	get autoEvent(){return this.getAttribute('autoEvent')};set autoEvent(autoEvent){this.setAttribute('autoEvent',autoEvent)}
	get axisLock(){return this.getAttribute('axisLock')};set axisLock(axisLock){this.setAttribute('axisLock',axisLock)}
	get badgeText(){return this.getAttribute('badgeText')};set badgeText(badgeText){this.setAttribute('badgeText',badgeText)}
	...
	get buttonType(){return this.getAttribute('buttonType')};set buttonType(buttonType){this.setAttribute('buttonType',buttonType)}
	...
	get pressed(){return this.getAttribute('pressed')};set pressed(pressed){this.setAttribute('pressed',pressed)}
	...
	get stretchMenu(){return this.getAttribute('stretchMenu')};set stretchMenu(stretchMenu){this.setAttribute('stretchMenu',stretchMenu)}
	...
	get toggleHandler(){return this.getAttribute('toggleHandler')};set toggleHandler(toggleHandler){this.setAttribute('toggleHandler',toggleHandler)}
