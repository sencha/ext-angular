...
export class ExtCalendar_form_editComponent extends ExtBase {
	...
	get api(){return this.getAttribute('api')};set api(api){this.setAttribute('api',api)}
	...
	get baseParams(){return this.getAttribute('baseParams')};set baseParams(baseParams){this.setAttribute('baseParams',baseParams)}
	...
	get calendarField(){return this.getAttribute('calendarField')};set calendarField(calendarField){this.setAttribute('calendarField',calendarField)}
	get cancelButton(){return this.getAttribute('cancelButton')};set cancelButton(cancelButton){this.setAttribute('cancelButton',cancelButton)}
	...
	get defaultEndTime(){return this.getAttribute('defaultEndTime')};set defaultEndTime(defaultEndTime){this.setAttribute('defaultEndTime',defaultEndTime)}
	...
	get defaultStartTime(){return this.getAttribute('defaultStartTime')};set defaultStartTime(defaultStartTime){this.setAttribute('defaultStartTime',defaultStartTime)}
	...
	get descriptionField(){return this.getAttribute('descriptionField')};set descriptionField(descriptionField){this.setAttribute('descriptionField',descriptionField)}
	...
	get dropButton(){return this.getAttribute('dropButton')};set dropButton(dropButton){this.setAttribute('dropButton',dropButton)}
	...
	get inputBorders(){return this.getAttribute('inputBorders')};set inputBorders(inputBorders){this.setAttribute('inputBorders',inputBorders)}
	...
	get method(){return this.getAttribute('method')};set method(method){this.setAttribute('method',method)}
	...
	get multipartDetection(){return this.getAttribute('multipartDetection')};set multipartDetection(multipartDetection){this.setAttribute('multipartDetection',multipartDetection)}
	...
	get paramOrder(){return this.getAttribute('paramOrder')};set paramOrder(paramOrder){this.setAttribute('paramOrder',paramOrder)}
	get paramsAsHash(){return this.getAttribute('paramsAsHash')};set paramsAsHash(paramsAsHash){this.setAttribute('paramsAsHash',paramsAsHash)}
	...
	get saveButton(){return this.getAttribute('saveButton')};set saveButton(saveButton){this.setAttribute('saveButton',saveButton)}
	...
	get standardSubmit(){return this.getAttribute('standardSubmit')};set standardSubmit(standardSubmit){this.setAttribute('standardSubmit',standardSubmit)}
	get startDateField(){return this.getAttribute('startDateField')};set startDateField(startDateField){this.setAttribute('startDateField',startDateField)}
	get startTimeField(){return this.getAttribute('startTimeField')};set startTimeField(startTimeField){this.setAttribute('startTimeField',startTimeField)}
	...
	get submitOnAction(){return this.getAttribute('submitOnAction')};set submitOnAction(submitOnAction){this.setAttribute('submitOnAction',submitOnAction)}
	...
	get timeout(){return this.getAttribute('timeout')};set timeout(timeout){this.setAttribute('timeout',timeout)}
	...
	get titleField(){return this.getAttribute('titleField')};set titleField(titleField){this.setAttribute('titleField',titleField)}
	...
	get trackResetOnLoad(){return this.getAttribute('trackResetOnLoad')};set trackResetOnLoad(trackResetOnLoad){this.setAttribute('trackResetOnLoad',trackResetOnLoad)}
	...
	get url(){return this.getAttribute('url')};set url(url){this.setAttribute('url',url)}
	...
	get view(){return this.getAttribute('view')};set view(view){this.setAttribute('view',view)}
	...
	get ondrop(){return this.getAttribute('ondrop')};set ondrop(ondrop){this.setAttribute('ondrop',ondrop)}
	...
	get onsave(){return this.getAttribute('onsave')};set onsave(onsave){this.setAttribute('onsave',onsave)}
	...
	static XTYPE() {return 'calendar_form_edit'}
