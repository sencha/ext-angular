(function () {
class ExtPasswordfield extends ExtBase {
	...
	get revealable(){return this.getAttribute('revealable')};set revealable(revealable){this.setAttribute('revealable',revealable)}
	get revealed(){return this.getAttribute('revealed')};set revealed(revealed){this.setAttribute('revealed',revealed)}
