...
export class ExtLockedgridregionComponent extends ExtBase {
	...
	get regionKey(){return this.getAttribute('regionKey')};set regionKey(regionKey){this.setAttribute('regionKey',regionKey)}
