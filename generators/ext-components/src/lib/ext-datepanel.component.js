...
class ExtDatepanel extends ExtBase {
	...
	get anchor(){return this.getAttribute('anchor')};set anchor(anchor){this.setAttribute('anchor',anchor)}
	get anchorPosition(){return this.getAttribute('anchorPosition')};set anchorPosition(anchorPosition){this.setAttribute('anchorPosition',anchorPosition)}
	...
	get autoConfirm(){return this.getAttribute('autoConfirm')};set autoConfirm(autoConfirm){this.setAttribute('autoConfirm',autoConfirm)}
	...
	get bbar(){return this.getAttribute('bbar')};set bbar(bbar){this.setAttribute('bbar',bbar)}
	get bind(){return this.getAttribute('bind')};set bind(bind){this.setAttribute('bind',bind)}
	get bodyBorder(){return this.getAttribute('bodyBorder')};set bodyBorder(bodyBorder){this.setAttribute('bodyBorder',bodyBorder)}
	get bodyPadding(){return this.getAttribute('bodyPadding')};set bodyPadding(bodyPadding){this.setAttribute('bodyPadding',bodyPadding)}
	get bodyStyle(){return this.getAttribute('bodyStyle')};set bodyStyle(bodyStyle){this.setAttribute('bodyStyle',bodyStyle)}
	...
	get buttonAlign(){return this.getAttribute('buttonAlign')};set buttonAlign(buttonAlign){this.setAttribute('buttonAlign',buttonAlign)}
	get buttons(){return this.getAttribute('buttons')};set buttons(buttons){this.setAttribute('buttons',buttons)}
	get buttonToolbar(){return this.getAttribute('buttonToolbar')};set buttonToolbar(buttonToolbar){this.setAttribute('buttonToolbar',buttonToolbar)}
	get captionFormat(){return this.getAttribute('captionFormat')};set captionFormat(captionFormat){this.setAttribute('captionFormat',captionFormat)}
	...
	get closable(){return this.getAttribute('closable')};set closable(closable){this.setAttribute('closable',closable)}
	get closeAction(){return this.getAttribute('closeAction')};set closeAction(closeAction){this.setAttribute('closeAction',closeAction)}
	get closeToolText(){return this.getAttribute('closeToolText')};set closeToolText(closeToolText){this.setAttribute('closeToolText',closeToolText)}
	get cls(){return this.getAttribute('cls')};set cls(cls){this.setAttribute('cls',cls)}
	get collapsed(){return this.getAttribute('collapsed')};set collapsed(collapsed){this.setAttribute('collapsed',collapsed)}
	get collapsible(){return this.getAttribute('collapsible')};set collapsible(collapsible){this.setAttribute('collapsible',collapsible)}
	...
	get dateCellFormat(){return this.getAttribute('dateCellFormat')};set dateCellFormat(dateCellFormat){this.setAttribute('dateCellFormat',dateCellFormat)}
	...
	get disabledDates(){return this.getAttribute('disabledDates')};set disabledDates(disabledDates){this.setAttribute('disabledDates',disabledDates)}
	get disabledDays(){return this.getAttribute('disabledDays')};set disabledDays(disabledDays){this.setAttribute('disabledDays',disabledDays)}
	...
	get focusableDate(){return this.getAttribute('focusableDate')};set focusableDate(focusableDate){this.setAttribute('focusableDate',focusableDate)}
	...
	get header(){return this.getAttribute('header')};set header(header){this.setAttribute('header',header)}
	get headerFormat(){return this.getAttribute('headerFormat')};set headerFormat(headerFormat){this.setAttribute('headerFormat',headerFormat)}
	get headerLength(){return this.getAttribute('headerLength')};set headerLength(headerLength){this.setAttribute('headerLength',headerLength)}
	get headerPosition(){return this.getAttribute('headerPosition')};set headerPosition(headerPosition){this.setAttribute('headerPosition',headerPosition)}
	...
	get hideCaptions(){return this.getAttribute('hideCaptions')};set hideCaptions(hideCaptions){this.setAttribute('hideCaptions',hideCaptions)}
	...
	get hideOutside(){return this.getAttribute('hideOutside')};set hideOutside(hideOutside){this.setAttribute('hideOutside',hideOutside)}
	get html(){return this.getAttribute('html')};set html(html){this.setAttribute('html',html)}
	get icon(){return this.getAttribute('icon')};set icon(icon){this.setAttribute('icon',icon)}
	get iconAlign(){return this.getAttribute('iconAlign')};set iconAlign(iconAlign){this.setAttribute('iconAlign',iconAlign)}
	...
	get lbar(){return this.getAttribute('lbar')};set lbar(lbar){this.setAttribute('lbar',lbar)}
	...
	get maxDate(){return this.getAttribute('maxDate')};set maxDate(maxDate){this.setAttribute('maxDate',maxDate)}
	...
	get minDate(){return this.getAttribute('minDate')};set minDate(minDate){this.setAttribute('minDate',minDate)}
	...
	get navigationPosition(){return this.getAttribute('navigationPosition')};set navigationPosition(navigationPosition){this.setAttribute('navigationPosition',navigationPosition)}
	get nextText(){return this.getAttribute('nextText')};set nextText(nextText){this.setAttribute('nextText',nextText)}
	get padding(){return this.getAttribute('padding')};set padding(padding){this.setAttribute('padding',padding)}
	get panes(){return this.getAttribute('panes')};set panes(panes){this.setAttribute('panes',panes)}
	get plugins(){return this.getAttribute('plugins')};set plugins(plugins){this.setAttribute('plugins',plugins)}
	get prevText(){return this.getAttribute('prevText')};set prevText(prevText){this.setAttribute('prevText',prevText)}
	get publishes(){return this.getAttribute('publishes')};set publishes(publishes){this.setAttribute('publishes',publishes)}
	get rbar(){return this.getAttribute('rbar')};set rbar(rbar){this.setAttribute('rbar',rbar)}
	...
	get resizable(){return this.getAttribute('resizable')};set resizable(resizable){this.setAttribute('resizable',resizable)}
	...
	get selectOnNavigate(){return this.getAttribute('selectOnNavigate')};set selectOnNavigate(selectOnNavigate){this.setAttribute('selectOnNavigate',selectOnNavigate)}
	...
	get showAfterMaxDate(){return this.getAttribute('showAfterMaxDate')};set showAfterMaxDate(showAfterMaxDate){this.setAttribute('showAfterMaxDate',showAfterMaxDate)}
	...
	get showBeforeMinDate(){return this.getAttribute('showBeforeMinDate')};set showBeforeMinDate(showBeforeMinDate){this.setAttribute('showBeforeMinDate',showBeforeMinDate)}
	get showFooter(){return this.getAttribute('showFooter')};set showFooter(showFooter){this.setAttribute('showFooter',showFooter)}
	get showTodayButton(){return this.getAttribute('showTodayButton')};set showTodayButton(showTodayButton){this.setAttribute('showTodayButton',showTodayButton)}
	get specialDates(){return this.getAttribute('specialDates')};set specialDates(specialDates){this.setAttribute('specialDates',specialDates)}
	get specialDays(){return this.getAttribute('specialDays')};set specialDays(specialDays){this.setAttribute('specialDays',specialDays)}
	get splitTitle(){return this.getAttribute('splitTitle')};set splitTitle(splitTitle){this.setAttribute('splitTitle',splitTitle)}
	get standardButtons(){return this.getAttribute('standardButtons')};set standardButtons(standardButtons){this.setAttribute('standardButtons',standardButtons)}
	get startDay(){return this.getAttribute('startDay')};set startDay(startDay){this.setAttribute('startDay',startDay)}
	...
	get tbar(){return this.getAttribute('tbar')};set tbar(tbar){this.setAttribute('tbar',tbar)}
	get title(){return this.getAttribute('title')};set title(title){this.setAttribute('title',title)}
	get titleAlign(){return this.getAttribute('titleAlign')};set titleAlign(titleAlign){this.setAttribute('titleAlign',titleAlign)}
	get titleAnimation(){return this.getAttribute('titleAnimation')};set titleAnimation(titleAnimation){this.setAttribute('titleAnimation',titleAnimation)}
	...
	get toolDefaults(){return this.getAttribute('toolDefaults')};set toolDefaults(toolDefaults){this.setAttribute('toolDefaults',toolDefaults)}
	get tools(){return this.getAttribute('tools')};set tools(tools){this.setAttribute('tools',tools)}
	...
	get transformCellCls(){return this.getAttribute('transformCellCls')};set transformCellCls(transformCellCls){this.setAttribute('transformCellCls',transformCellCls)}
	...
	get weekendDays(){return this.getAttribute('weekendDays')};set weekendDays(weekendDays){this.setAttribute('weekendDays',weekendDays)}
