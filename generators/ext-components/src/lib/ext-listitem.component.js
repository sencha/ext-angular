...
export class ExtListitemComponent extends ExtBase {
	...
	get dataMap(){return this.getAttribute('dataMap')};set dataMap(dataMap){this.setAttribute('dataMap',dataMap)}
	...
	get pinned(){return this.getAttribute('pinned')};set pinned(pinned){this.setAttribute('pinned',pinned)}
	...
	get recordIndex(){return this.getAttribute('recordIndex')};set recordIndex(recordIndex){this.setAttribute('recordIndex',recordIndex)}
