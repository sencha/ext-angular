(function () {
class ExtTooltip extends ExtBase {
	...
	get alignDelegate(){return this.getAttribute('alignDelegate')};set alignDelegate(alignDelegate){this.setAttribute('alignDelegate',alignDelegate)}
	...
	get allowOver(){return this.getAttribute('allowOver')};set allowOver(allowOver){this.setAttribute('allowOver',allowOver)}
	...
	get anchorToTarget(){return this.getAttribute('anchorToTarget')};set anchorToTarget(anchorToTarget){this.setAttribute('anchorToTarget',anchorToTarget)}
	...
	get autoHide(){return this.getAttribute('autoHide')};set autoHide(autoHide){this.setAttribute('autoHide',autoHide)}
	...
	get delegate(){return this.getAttribute('delegate')};set delegate(delegate){this.setAttribute('delegate',delegate)}
	get disabled(){return this.getAttribute('disabled')};set disabled(disabled){this.setAttribute('disabled',disabled)}
	get dismissDelay(){return this.getAttribute('dismissDelay')};set dismissDelay(dismissDelay){this.setAttribute('dismissDelay',dismissDelay)}
	...
	get hideDelay(){return this.getAttribute('hideDelay')};set hideDelay(hideDelay){this.setAttribute('hideDelay',hideDelay)}
	...
	get mouseOffset(){return this.getAttribute('mouseOffset')};set mouseOffset(mouseOffset){this.setAttribute('mouseOffset',mouseOffset)}
	...
	get quickShowInterval(){return this.getAttribute('quickShowInterval')};set quickShowInterval(quickShowInterval){this.setAttribute('quickShowInterval',quickShowInterval)}
	...
	get showDelay(){return this.getAttribute('showDelay')};set showDelay(showDelay){this.setAttribute('showDelay',showDelay)}
	get showOnTap(){return this.getAttribute('showOnTap')};set showOnTap(showOnTap){this.setAttribute('showOnTap',showOnTap)}
	...
	get target(){return this.getAttribute('target')};set target(target){this.setAttribute('target',target)}
	...
	get trackMouse(){return this.getAttribute('trackMouse')};set trackMouse(trackMouse){this.setAttribute('trackMouse',trackMouse)}
