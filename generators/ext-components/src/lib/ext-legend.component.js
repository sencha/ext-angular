(function () {
class ExtLegend extends ExtBase {
	...
	get rect(){return this.getAttribute('rect')};set rect(rect){this.setAttribute('rect',rect)}
	...
	get toggleable(){return this.getAttribute('toggleable')};set toggleable(toggleable){this.setAttribute('toggleable',toggleable)}
