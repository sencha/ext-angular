(function () {
class ExtSegmentedbutton extends ExtBase {
	...
	get allowMultiple(){return this.getAttribute('allowMultiple')};set allowMultiple(allowMultiple){this.setAttribute('allowMultiple',allowMultiple)}
	get allowToggle(){return this.getAttribute('allowToggle')};set allowToggle(allowToggle){this.setAttribute('allowToggle',allowToggle)}
	...
	get defaultUI(){return this.getAttribute('defaultUI')};set defaultUI(defaultUI){this.setAttribute('defaultUI',defaultUI)}
	...
	get pressedButtons(){return this.getAttribute('pressedButtons')};set pressedButtons(pressedButtons){this.setAttribute('pressedButtons',pressedButtons)}
