(function () {
class ExtCalendar extends ExtBase {
	...
	get calendarList(){return this.getAttribute('calendarList')};set calendarList(calendarList){this.setAttribute('calendarList',calendarList)}
	...
	get createButton(){return this.getAttribute('createButton')};set createButton(createButton){this.setAttribute('createButton',createButton)}
	get createButtonPosition(){return this.getAttribute('createButtonPosition')};set createButtonPosition(createButtonPosition){this.setAttribute('createButtonPosition',createButtonPosition)}
	get data(){return this.getAttribute('data')};set data(data){this.setAttribute('data',data)}
	get dateTitle(){return this.getAttribute('dateTitle')};set dateTitle(dateTitle){this.setAttribute('dateTitle',dateTitle)}
	...
	get menuButton(){return this.getAttribute('menuButton')};set menuButton(menuButton){this.setAttribute('menuButton',menuButton)}
	...
	get nextButton(){return this.getAttribute('nextButton')};set nextButton(nextButton){this.setAttribute('nextButton',nextButton)}
	...
	get previousButton(){return this.getAttribute('previousButton')};set previousButton(previousButton){this.setAttribute('previousButton',previousButton)}
	...
	get sheet(){return this.getAttribute('sheet')};set sheet(sheet){this.setAttribute('sheet',sheet)}
	...
	get sideBar(){return this.getAttribute('sideBar')};set sideBar(sideBar){this.setAttribute('sideBar',sideBar)}
	...
	get switcher(){return this.getAttribute('switcher')};set switcher(switcher){this.setAttribute('switcher',switcher)}
	get switcherPosition(){return this.getAttribute('switcherPosition')};set switcherPosition(switcherPosition){this.setAttribute('switcherPosition',switcherPosition)}
	...
	get todayButton(){return this.getAttribute('todayButton')};set todayButton(todayButton){this.setAttribute('todayButton',todayButton)}
