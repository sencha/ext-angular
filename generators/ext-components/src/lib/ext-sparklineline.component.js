...
export class ExtSparklinelineComponent extends ExtBase {
	...
	get chartRangeMax(){return this.getAttribute('chartRangeMax')};set chartRangeMax(chartRangeMax){this.setAttribute('chartRangeMax',chartRangeMax)}
	get chartRangeMaxX(){return this.getAttribute('chartRangeMaxX')};set chartRangeMaxX(chartRangeMaxX){this.setAttribute('chartRangeMaxX',chartRangeMaxX)}
	get chartRangeMin(){return this.getAttribute('chartRangeMin')};set chartRangeMin(chartRangeMin){this.setAttribute('chartRangeMin',chartRangeMin)}
	get chartRangeMinX(){return this.getAttribute('chartRangeMinX')};set chartRangeMinX(chartRangeMinX){this.setAttribute('chartRangeMinX',chartRangeMinX)}
	...
	get disableTooltips(){return this.getAttribute('disableTooltips')};set disableTooltips(disableTooltips){this.setAttribute('disableTooltips',disableTooltips)}
	...
	get highlightColor(){return this.getAttribute('highlightColor')};set highlightColor(highlightColor){this.setAttribute('highlightColor',highlightColor)}
	get highlightLighten(){return this.getAttribute('highlightLighten')};set highlightLighten(highlightLighten){this.setAttribute('highlightLighten',highlightLighten)}
	get highlightLineColor(){return this.getAttribute('highlightLineColor')};set highlightLineColor(highlightLineColor){this.setAttribute('highlightLineColor',highlightLineColor)}
	get highlightSpotColor(){return this.getAttribute('highlightSpotColor')};set highlightSpotColor(highlightSpotColor){this.setAttribute('highlightSpotColor',highlightSpotColor)}
	...
	get lineColor(){return this.getAttribute('lineColor')};set lineColor(lineColor){this.setAttribute('lineColor',lineColor)}
	get lineWidth(){return this.getAttribute('lineWidth')};set lineWidth(lineWidth){this.setAttribute('lineWidth',lineWidth)}
	...
	get maxSpotColor(){return this.getAttribute('maxSpotColor')};set maxSpotColor(maxSpotColor){this.setAttribute('maxSpotColor',maxSpotColor)}
	...
	get minSpotColor(){return this.getAttribute('minSpotColor')};set minSpotColor(minSpotColor){this.setAttribute('minSpotColor',minSpotColor)}
	...
	get normalRangeColor(){return this.getAttribute('normalRangeColor')};set normalRangeColor(normalRangeColor){this.setAttribute('normalRangeColor',normalRangeColor)}
	get normalRangeMax(){return this.getAttribute('normalRangeMax')};set normalRangeMax(normalRangeMax){this.setAttribute('normalRangeMax',normalRangeMax)}
	get normalRangeMin(){return this.getAttribute('normalRangeMin')};set normalRangeMin(normalRangeMin){this.setAttribute('normalRangeMin',normalRangeMin)}
	...
	get spotColor(){return this.getAttribute('spotColor')};set spotColor(spotColor){this.setAttribute('spotColor',spotColor)}
	get spotRadius(){return this.getAttribute('spotRadius')};set spotRadius(spotRadius){this.setAttribute('spotRadius',spotRadius)}
	...
	get tipTpl(){return this.getAttribute('tipTpl')};set tipTpl(tipTpl){this.setAttribute('tipTpl',tipTpl)}
	...
	get tooltipPrefix(){return this.getAttribute('tooltipPrefix')};set tooltipPrefix(tooltipPrefix){this.setAttribute('tooltipPrefix',tooltipPrefix)}
	get tooltipSkipNull(){return this.getAttribute('tooltipSkipNull')};set tooltipSkipNull(tooltipSkipNull){this.setAttribute('tooltipSkipNull',tooltipSkipNull)}
	get tooltipSuffix(){return this.getAttribute('tooltipSuffix')};set tooltipSuffix(tooltipSuffix){this.setAttribute('tooltipSuffix',tooltipSuffix)}
	...
	get values(){return this.getAttribute('values')};set values(values){this.setAttribute('values',values)}
	get valueSpots(){return this.getAttribute('valueSpots')};set valueSpots(valueSpots){this.setAttribute('valueSpots',valueSpots)}
