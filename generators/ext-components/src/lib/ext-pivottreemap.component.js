(function () {
class ExtPivottreemap extends ExtBase {
	...
	get autoExpand(){return this.getAttribute('autoExpand')};set autoExpand(autoExpand){this.setAttribute('autoExpand',autoExpand)}
	...
	get busyLayoutText(){return this.getAttribute('busyLayoutText')};set busyLayoutText(busyLayoutText){this.setAttribute('busyLayoutText',busyLayoutText)}
	...
	get leafTile(){return this.getAttribute('leafTile')};set leafTile(leafTile){this.setAttribute('leafTile',leafTile)}
	...
	get parentTile(){return this.getAttribute('parentTile')};set parentTile(parentTile){this.setAttribute('parentTile',parentTile)}
	...
	get scaleLabels(){return this.getAttribute('scaleLabels')};set scaleLabels(scaleLabels){this.setAttribute('scaleLabels',scaleLabels)}
	...
	get tiling(){return this.getAttribute('tiling')};set tiling(tiling){this.setAttribute('tiling',tiling)}
