...
export class ExtSinglesliderfieldComponent extends ExtBase {
	...
	get boxLabel(){return this.getAttribute('boxLabel')};set boxLabel(boxLabel){this.setAttribute('boxLabel',boxLabel)}
	get boxLabelAlign(){return this.getAttribute('boxLabelAlign')};set boxLabelAlign(boxLabelAlign){this.setAttribute('boxLabelAlign',boxLabelAlign)}
	...
	get increment(){return this.getAttribute('increment')};set increment(increment){this.setAttribute('increment',increment)}
	...
	get liveUpdate(){return this.getAttribute('liveUpdate')};set liveUpdate(liveUpdate){this.setAttribute('liveUpdate',liveUpdate)}
	...
	get slider(){return this.getAttribute('slider')};set slider(slider){this.setAttribute('slider',slider)}
  ...
  constructor() {
    super()
    this.METHODS = ExtSinglesliderfieldComponent.METHODS()
    this.XTYPE = ExtSinglesliderfieldComponent.XTYPE()
    //this.PROPERTIES = ExtSinglesliderfieldComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtSinglesliderfieldComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtSinglesliderfieldComponent.EVENTS()
  }
