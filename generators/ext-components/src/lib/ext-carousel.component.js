(function () {
class ExtCarousel extends ExtBase {
	...
	get direction(){return this.getAttribute('direction')};set direction(direction){this.setAttribute('direction',direction)}
	...
	get indicator(){return this.getAttribute('indicator')};set indicator(indicator){this.setAttribute('indicator',indicator)}
