(function () {
class ExtSplitbutton extends ExtBase {
	...
	get arrowHandler(){return this.getAttribute('arrowHandler')};set arrowHandler(arrowHandler){this.setAttribute('arrowHandler',arrowHandler)}
