...
export class ExtDatepickerComponent extends ExtBase {
	...
	get cover(){return this.getAttribute('cover')};set cover(cover){this.setAttribute('cover',cover)}
	get data(){return this.getAttribute('data')};set data(data){this.setAttribute('data',data)}
	get dayText(){return this.getAttribute('dayText')};set dayText(dayText){this.setAttribute('dayText',dayText)}
	...
	get doneButton(){return this.getAttribute('doneButton')};set doneButton(doneButton){this.setAttribute('doneButton',doneButton)}
	...
	get monthText(){return this.getAttribute('monthText')};set monthText(monthText){this.setAttribute('monthText',monthText)}
	...
	get reveal(){return this.getAttribute('reveal')};set reveal(reveal){this.setAttribute('reveal',reveal)}
	...
	get slotOrder(){return this.getAttribute('slotOrder')};set slotOrder(slotOrder){this.setAttribute('slotOrder',slotOrder)}
	get slots(){return this.getAttribute('slots')};set slots(slots){this.setAttribute('slots',slots)}
	...
	get stretchX(){return this.getAttribute('stretchX')};set stretchX(stretchX){this.setAttribute('stretchX',stretchX)}
	get stretchY(){return this.getAttribute('stretchY')};set stretchY(stretchY){this.setAttribute('stretchY',stretchY)}
	...
	get toolbar(){return this.getAttribute('toolbar')};set toolbar(toolbar){this.setAttribute('toolbar',toolbar)}
	...
	get useTitles(){return this.getAttribute('useTitles')};set useTitles(useTitles){this.setAttribute('useTitles',useTitles)}
	...
	get yearFrom(){return this.getAttribute('yearFrom')};set yearFrom(yearFrom){this.setAttribute('yearFrom',yearFrom)}
	get yearText(){return this.getAttribute('yearText')};set yearText(yearText){this.setAttribute('yearText',yearText)}
	get yearTo(){return this.getAttribute('yearTo')};set yearTo(yearTo){this.setAttribute('yearTo',yearTo)}
