(function () {
class ExtNestedlist extends ExtBase {
	...
	get backButton(){return this.getAttribute('backButton')};set backButton(backButton){this.setAttribute('backButton',backButton)}
	get backText(){return this.getAttribute('backText')};set backText(backText){this.setAttribute('backText',backText)}
	...
	get detailCard(){return this.getAttribute('detailCard')};set detailCard(detailCard){this.setAttribute('detailCard',detailCard)}
	get detailContainer(){return this.getAttribute('detailContainer')};set detailContainer(detailContainer){this.setAttribute('detailContainer',detailContainer)}
	...
	get lastActiveList(){return this.getAttribute('lastActiveList')};set lastActiveList(lastActiveList){this.setAttribute('lastActiveList',lastActiveList)}
	get lastNode(){return this.getAttribute('lastNode')};set lastNode(lastNode){this.setAttribute('lastNode',lastNode)}
	...
	get listConfig(){return this.getAttribute('listConfig')};set listConfig(listConfig){this.setAttribute('listConfig',listConfig)}
	...
	get updateTitleText(){return this.getAttribute('updateTitleText')};set updateTitleText(updateTitleText){this.setAttribute('updateTitleText',updateTitleText)}
