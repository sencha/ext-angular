(function () {
class ExtSpinnerfield extends ExtBase {
	...
	get groupButtons(){return this.getAttribute('groupButtons')};set groupButtons(groupButtons){this.setAttribute('groupButtons',groupButtons)}
	...
	get maxValue(){return this.getAttribute('maxValue')};set maxValue(maxValue){this.setAttribute('maxValue',maxValue)}
	get maxValueText(){return this.getAttribute('maxValueText')};set maxValueText(maxValueText){this.setAttribute('maxValueText',maxValueText)}
	...
	get minValue(){return this.getAttribute('minValue')};set minValue(minValue){this.setAttribute('minValue',minValue)}
	get minValueText(){return this.getAttribute('minValueText')};set minValueText(minValueText){this.setAttribute('minValueText',minValueText)}
	...
	get stepValue(){return this.getAttribute('stepValue')};set stepValue(stepValue){this.setAttribute('stepValue',stepValue)}
	...
	get trim(){return this.getAttribute('trim')};set trim(trim){this.setAttribute('trim',trim)}
