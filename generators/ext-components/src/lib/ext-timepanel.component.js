(function () {
class ExtTimepanel extends ExtBase {
	...
	get autoAdvance(){return this.getAttribute('autoAdvance')};set autoAdvance(autoAdvance){this.setAttribute('autoAdvance',autoAdvance)}
	...
	get confirmable(){return this.getAttribute('confirmable')};set confirmable(confirmable){this.setAttribute('confirmable',confirmable)}
	...
	get declineHandler(){return this.getAttribute('declineHandler')};set declineHandler(declineHandler){this.setAttribute('declineHandler',declineHandler)}
	get defaultButtons(){return this.getAttribute('defaultButtons')};set defaultButtons(defaultButtons){this.setAttribute('defaultButtons',defaultButtons)}
	...
	get mode(){return this.getAttribute('mode')};set mode(mode){this.setAttribute('mode',mode)}
	...
	get vertical(){return this.getAttribute('vertical')};set vertical(vertical){this.setAttribute('vertical',vertical)}
