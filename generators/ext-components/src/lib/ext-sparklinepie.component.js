(function () {
class ExtSparklinepie extends ExtBase {
	...
	get borderColor(){return this.getAttribute('borderColor')};set borderColor(borderColor){this.setAttribute('borderColor',borderColor)}
	get borderWidth(){return this.getAttribute('borderWidth')};set borderWidth(borderWidth){this.setAttribute('borderWidth',borderWidth)}
	...
	get sliceColors(){return this.getAttribute('sliceColors')};set sliceColors(sliceColors){this.setAttribute('sliceColors',sliceColors)}
