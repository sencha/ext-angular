(function () {
class ExtCartesian extends ExtBase {
	...
	get axes(){return this.getAttribute('axes')};set axes(axes){this.setAttribute('axes',axes)}
	...
	get captions(){return this.getAttribute('captions')};set captions(captions){this.setAttribute('captions',captions)}
	...
	get colors(){return this.getAttribute('colors')};set colors(colors){this.setAttribute('colors',colors)}
	...
	get downloadServerUrl(){return this.getAttribute('downloadServerUrl')};set downloadServerUrl(downloadServerUrl){this.setAttribute('downloadServerUrl',downloadServerUrl)}
	get draggable(){return this.getAttribute('draggable')};set draggable(draggable){this.setAttribute('draggable',draggable)}
	get engine(){return this.getAttribute('engine')};set engine(engine){this.setAttribute('engine',engine)}
	...
	get flipXY(){return this.getAttribute('flipXY')};set flipXY(flipXY){this.setAttribute('flipXY',flipXY)}
	...
	get gradients(){return this.getAttribute('gradients')};set gradients(gradients){this.setAttribute('gradients',gradients)}
	...
	get highlightItem(){return this.getAttribute('highlightItem')};set highlightItem(highlightItem){this.setAttribute('highlightItem',highlightItem)}
	...
	get innerPadding(){return this.getAttribute('innerPadding')};set innerPadding(innerPadding){this.setAttribute('innerPadding',innerPadding)}
	get insetPadding(){return this.getAttribute('insetPadding')};set insetPadding(insetPadding){this.setAttribute('insetPadding',insetPadding)}
	...
	get legend(){return this.getAttribute('legend')};set legend(legend){this.setAttribute('legend',legend)}
	get listeners(){return this.getAttribute('listeners')};set listeners(listeners){this.setAttribute('listeners',listeners)}
	get mainRect(){return this.getAttribute('mainRect')};set mainRect(mainRect){this.setAttribute('mainRect',mainRect)}
	...
	get resizeHandler(){return this.getAttribute('resizeHandler')};set resizeHandler(resizeHandler){this.setAttribute('resizeHandler',resizeHandler)}
	...
	get series(){return this.getAttribute('series')};set series(series){this.setAttribute('series',series)}
	...
	get sprites(){return this.getAttribute('sprites')};set sprites(sprites){this.setAttribute('sprites',sprites)}
	...
	get surfaceZIndexes(){return this.getAttribute('surfaceZIndexes')};set surfaceZIndexes(surfaceZIndexes){this.setAttribute('surfaceZIndexes',surfaceZIndexes)}
	get tabIndex(){return this.getAttribute('tabIndex')};set tabIndex(tabIndex){this.setAttribute('tabIndex',tabIndex)}
	get theme(){return this.getAttribute('theme')};set theme(theme){this.setAttribute('theme',theme)}
