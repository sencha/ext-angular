(function () {
class ExtPanelheader extends ExtBase {
	...
	get glyph(){return this.getAttribute('glyph')};set glyph(glyph){this.setAttribute('glyph',glyph)}
	...
	get titleRotation(){return this.getAttribute('titleRotation')};set titleRotation(titleRotation){this.setAttribute('titleRotation',titleRotation)}
