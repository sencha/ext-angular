...
export class ExtFieldcontainerComponent extends ExtBase {
	...
	get container(){return this.getAttribute('container')};set container(container){this.setAttribute('container',container)}
