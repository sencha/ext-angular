...
class ExtSparklinebar extends ExtBase {
	...
	get barColor(){return this.getAttribute('barColor')};set barColor(barColor){this.setAttribute('barColor',barColor)}
	get barSpacing(){return this.getAttribute('barSpacing')};set barSpacing(barSpacing){this.setAttribute('barSpacing',barSpacing)}
	get barWidth(){return this.getAttribute('barWidth')};set barWidth(barWidth){this.setAttribute('barWidth',barWidth)}
	...
	get chartRangeClip(){return this.getAttribute('chartRangeClip')};set chartRangeClip(chartRangeClip){this.setAttribute('chartRangeClip',chartRangeClip)}
	...
	get colorMap(){return this.getAttribute('colorMap')};set colorMap(colorMap){this.setAttribute('colorMap',colorMap)}
	...
	get negBarColor(){return this.getAttribute('negBarColor')};set negBarColor(negBarColor){this.setAttribute('negBarColor',negBarColor)}
	get nullColor(){return this.getAttribute('nullColor')};set nullColor(nullColor){this.setAttribute('nullColor',nullColor)}
	...
	get stackedBarColor(){return this.getAttribute('stackedBarColor')};set stackedBarColor(stackedBarColor){this.setAttribute('stackedBarColor',stackedBarColor)}
