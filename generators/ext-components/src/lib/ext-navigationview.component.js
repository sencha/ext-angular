...
export class ExtNavigationviewComponent extends ExtBase {
	...
	get defaultBackButtonText(){return this.getAttribute('defaultBackButtonText')};set defaultBackButtonText(defaultBackButtonText){this.setAttribute('defaultBackButtonText',defaultBackButtonText)}
	...
	get navigationBar(){return this.getAttribute('navigationBar')};set navigationBar(navigationBar){this.setAttribute('navigationBar',navigationBar)}
	...
	get useTitleForBackButtonText(){return this.getAttribute('useTitleForBackButtonText')};set useTitleForBackButtonText(useTitleForBackButtonText){this.setAttribute('useTitleForBackButtonText',useTitleForBackButtonText)}
