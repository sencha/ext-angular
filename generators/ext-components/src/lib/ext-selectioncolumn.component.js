(function () {
class ExtSelectioncolumn extends ExtBase {
	...
	get cell(){return this.getAttribute('cell')};set cell(cell){this.setAttribute('cell',cell)}
	...
	get computedWidth(){return this.getAttribute('computedWidth')};set computedWidth(computedWidth){this.setAttribute('computedWidth',computedWidth)}
	...
	get dataIndex(){return this.getAttribute('dataIndex')};set dataIndex(dataIndex){this.setAttribute('dataIndex',dataIndex)}
	get defaultColumnUI(){return this.getAttribute('defaultColumnUI')};set defaultColumnUI(defaultColumnUI){this.setAttribute('defaultColumnUI',defaultColumnUI)}
	get defaultEditor(){return this.getAttribute('defaultEditor')};set defaultEditor(defaultEditor){this.setAttribute('defaultEditor',defaultEditor)}
	...
	get defaultWidth(){return this.getAttribute('defaultWidth')};set defaultWidth(defaultWidth){this.setAttribute('defaultWidth',defaultWidth)}
	get depends(){return this.getAttribute('depends')};set depends(depends){this.setAttribute('depends',depends)}
	...
	get filter(){return this.getAttribute('filter')};set filter(filter){this.setAttribute('filter',filter)}
	...
	get formatter(){return this.getAttribute('formatter')};set formatter(formatter){this.setAttribute('formatter',formatter)}
	get fullscreen(){return this.getAttribute('fullscreen')};set fullscreen(fullscreen){this.setAttribute('fullscreen',fullscreen)}
	get groupable(){return this.getAttribute('groupable')};set groupable(groupable){this.setAttribute('groupable',groupable)}
	get grouper(){return this.getAttribute('grouper')};set grouper(grouper){this.setAttribute('grouper',grouper)}
	get groupHeaderTpl(){return this.getAttribute('groupHeaderTpl')};set groupHeaderTpl(groupHeaderTpl){this.setAttribute('groupHeaderTpl',groupHeaderTpl)}
	get headerCheckbox(){return this.getAttribute('headerCheckbox')};set headerCheckbox(headerCheckbox){this.setAttribute('headerCheckbox',headerCheckbox)}
	get headerCheckboxAlign(){return this.getAttribute('headerCheckboxAlign')};set headerCheckboxAlign(headerCheckboxAlign){this.setAttribute('headerCheckboxAlign',headerCheckboxAlign)}
	...
	get hideable(){return this.getAttribute('hideable')};set hideable(hideable){this.setAttribute('hideable',hideable)}
	...
	get hideShowMenuItem(){return this.getAttribute('hideShowMenuItem')};set hideShowMenuItem(hideShowMenuItem){this.setAttribute('hideShowMenuItem',hideShowMenuItem)}
	...
	get ignore(){return this.getAttribute('ignore')};set ignore(ignore){this.setAttribute('ignore',ignore)}
	get ignoreExport(){return this.getAttribute('ignoreExport')};set ignoreExport(ignoreExport){this.setAttribute('ignoreExport',ignoreExport)}
	...
	get locked(){return this.getAttribute('locked')};set locked(locked){this.setAttribute('locked',locked)}
	...
	get menu(){return this.getAttribute('menu')};set menu(menu){this.setAttribute('menu',menu)}
	get menuDisabled(){return this.getAttribute('menuDisabled')};set menuDisabled(menuDisabled){this.setAttribute('menuDisabled',menuDisabled)}
	...
	get scratchCell(){return this.getAttribute('scratchCell')};set scratchCell(scratchCell){this.setAttribute('scratchCell',scratchCell)}
	...
	get stopSelection(){return this.getAttribute('stopSelection')};set stopSelection(stopSelection){this.setAttribute('stopSelection',stopSelection)}
	get style(){return this.getAttribute('style')};set style(style){this.setAttribute('style',style)}
	get summary(){return this.getAttribute('summary')};set summary(summary){this.setAttribute('summary',summary)}
	get summaryCell(){return this.getAttribute('summaryCell')};set summaryCell(summaryCell){this.setAttribute('summaryCell',summaryCell)}
