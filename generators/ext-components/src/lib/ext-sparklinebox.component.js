...
export class ExtSparklineboxComponent extends ExtBase {
	...
	get boxFillColor(){return this.getAttribute('boxFillColor')};set boxFillColor(boxFillColor){this.setAttribute('boxFillColor',boxFillColor)}
	get boxLineColor(){return this.getAttribute('boxLineColor')};set boxLineColor(boxLineColor){this.setAttribute('boxLineColor',boxLineColor)}
	...
	get medianColor(){return this.getAttribute('medianColor')};set medianColor(medianColor){this.setAttribute('medianColor',medianColor)}
	...
	get outlierFillColor(){return this.getAttribute('outlierFillColor')};set outlierFillColor(outlierFillColor){this.setAttribute('outlierFillColor',outlierFillColor)}
	get outlierIQR(){return this.getAttribute('outlierIQR')};set outlierIQR(outlierIQR){this.setAttribute('outlierIQR',outlierIQR)}
	get outlierLineColor(){return this.getAttribute('outlierLineColor')};set outlierLineColor(outlierLineColor){this.setAttribute('outlierLineColor',outlierLineColor)}
	...
	get raw(){return this.getAttribute('raw')};set raw(raw){this.setAttribute('raw',raw)}
	...
	get showOutliers(){return this.getAttribute('showOutliers')};set showOutliers(showOutliers){this.setAttribute('showOutliers',showOutliers)}
	...
	get targetColor(){return this.getAttribute('targetColor')};set targetColor(targetColor){this.setAttribute('targetColor',targetColor)}
	...
	get whiskerColor(){return this.getAttribute('whiskerColor')};set whiskerColor(whiskerColor){this.setAttribute('whiskerColor',whiskerColor)}
  ...
  constructor() {
    super()
    this.METHODS = ExtSparklineboxComponent.METHODS()
    this.XTYPE = ExtSparklineboxComponent.XTYPE()
    //this.PROPERTIES = ExtSparklineboxComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtSparklineboxComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtSparklineboxComponent.EVENTS()
  }
