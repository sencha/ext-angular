...
export class ExtPivotconfigpanelComponent extends ExtBase {
	...
	get panelAggFieldsText(){return this.getAttribute('panelAggFieldsText')};set panelAggFieldsText(panelAggFieldsText){this.setAttribute('panelAggFieldsText',panelAggFieldsText)}
	get panelAggFieldsTitle(){return this.getAttribute('panelAggFieldsTitle')};set panelAggFieldsTitle(panelAggFieldsTitle){this.setAttribute('panelAggFieldsTitle',panelAggFieldsTitle)}
	get panelAllFieldsText(){return this.getAttribute('panelAllFieldsText')};set panelAllFieldsText(panelAllFieldsText){this.setAttribute('panelAllFieldsText',panelAllFieldsText)}
	get panelAllFieldsTitle(){return this.getAttribute('panelAllFieldsTitle')};set panelAllFieldsTitle(panelAllFieldsTitle){this.setAttribute('panelAllFieldsTitle',panelAllFieldsTitle)}
	get panelLeftFieldsText(){return this.getAttribute('panelLeftFieldsText')};set panelLeftFieldsText(panelLeftFieldsText){this.setAttribute('panelLeftFieldsText',panelLeftFieldsText)}
	get panelLeftFieldsTitle(){return this.getAttribute('panelLeftFieldsTitle')};set panelLeftFieldsTitle(panelLeftFieldsTitle){this.setAttribute('panelLeftFieldsTitle',panelLeftFieldsTitle)}
	get panelTopFieldsText(){return this.getAttribute('panelTopFieldsText')};set panelTopFieldsText(panelTopFieldsText){this.setAttribute('panelTopFieldsText',panelTopFieldsText)}
	get panelTopFieldsTitle(){return this.getAttribute('panelTopFieldsTitle')};set panelTopFieldsTitle(panelTopFieldsTitle){this.setAttribute('panelTopFieldsTitle',panelTopFieldsTitle)}
  ...
  constructor() {
    super()
    this.METHODS = ExtPivotconfigpanelComponent.METHODS()
    this.XTYPE = ExtPivotconfigpanelComponent.XTYPE()
    //this.PROPERTIES = ExtPivotconfigpanelComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtPivotconfigpanelComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtPivotconfigpanelComponent.EVENTS()
  }
