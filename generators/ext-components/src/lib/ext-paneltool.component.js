(function () {
class ExtPaneltool extends ExtBase {
	...
	get passive(){return this.getAttribute('passive')};set passive(passive){this.setAttribute('passive',passive)}
	...
	get stopEvent(){return this.getAttribute('stopEvent')};set stopEvent(stopEvent){this.setAttribute('stopEvent',stopEvent)}
	...
	get toolOwner(){return this.getAttribute('toolOwner')};set toolOwner(toolOwner){this.setAttribute('toolOwner',toolOwner)}
	...
	get type(){return this.getAttribute('type')};set type(type){this.setAttribute('type',type)}
