(function () {
class ExtPickerslot extends ExtBase {
	...
	get showTitle(){return this.getAttribute('showTitle')};set showTitle(showTitle){this.setAttribute('showTitle',showTitle)}
	...
	get verticallyCenterItems(){return this.getAttribute('verticallyCenterItems')};set verticallyCenterItems(verticallyCenterItems){this.setAttribute('verticallyCenterItems',verticallyCenterItems)}
