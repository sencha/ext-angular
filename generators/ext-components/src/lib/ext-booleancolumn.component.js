(function () {
class ExtBooleancolumn extends ExtBase {
	...
	get falseText(){return this.getAttribute('falseText')};set falseText(falseText){this.setAttribute('falseText',falseText)}
	...
	get trueText(){return this.getAttribute('trueText')};set trueText(trueText){this.setAttribute('trueText',trueText)}
	...
	get undefinedText(){return this.getAttribute('undefinedText')};set undefinedText(undefinedText){this.setAttribute('undefinedText',undefinedText)}
