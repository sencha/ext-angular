...
export class ExtCalendar_monthComponent extends ExtBase {
	...
	get dayFormat(){return this.getAttribute('dayFormat')};set dayFormat(dayFormat){this.setAttribute('dayFormat',dayFormat)}
	...
	get overflowText(){return this.getAttribute('overflowText')};set overflowText(overflowText){this.setAttribute('overflowText',overflowText)}
	...
	get showOverflow(){return this.getAttribute('showOverflow')};set showOverflow(showOverflow){this.setAttribute('showOverflow',showOverflow)}
	...
	get visibleWeeks(){return this.getAttribute('visibleWeeks')};set visibleWeeks(visibleWeeks){this.setAttribute('visibleWeeks',visibleWeeks)}
