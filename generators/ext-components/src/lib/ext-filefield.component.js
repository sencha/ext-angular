(function () {
class ExtFilefield extends ExtBase {
	...
	get capture(){return this.getAttribute('capture')};set capture(capture){this.setAttribute('capture',capture)}
	...
	get multiple(){return this.getAttribute('multiple')};set multiple(multiple){this.setAttribute('multiple',multiple)}
