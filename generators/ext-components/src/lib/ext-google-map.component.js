(function () {
class ExtGoogle_map extends ExtBase {
	...
	get geo(){return this.getAttribute('geo')};set geo(geo){this.setAttribute('geo',geo)}
	...
	get map(){return this.getAttribute('map')};set map(map){this.setAttribute('map',map)}
	get mapListeners(){return this.getAttribute('mapListeners')};set mapListeners(mapListeners){this.setAttribute('mapListeners',mapListeners)}
	get mapOptions(){return this.getAttribute('mapOptions')};set mapOptions(mapOptions){this.setAttribute('mapOptions',mapOptions)}
	get margin(){return this.getAttribute('margin')};set margin(margin){this.setAttribute('margin',margin)}
	get markers(){return this.getAttribute('markers')};set markers(markers){this.setAttribute('markers',markers)}
	get markerTemplate(){return this.getAttribute('markerTemplate')};set markerTemplate(markerTemplate){this.setAttribute('markerTemplate',markerTemplate)}
	...
	get requiredScripts(){return this.getAttribute('requiredScripts')};set requiredScripts(requiredScripts){this.setAttribute('requiredScripts',requiredScripts)}
	...
	get useCurrentLocation(){return this.getAttribute('useCurrentLocation')};set useCurrentLocation(useCurrentLocation){this.setAttribute('useCurrentLocation',useCurrentLocation)}
	...
	static XTYPE() {return 'google_map'}
