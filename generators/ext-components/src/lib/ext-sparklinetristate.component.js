(function () {
class ExtSparklinetristate extends ExtBase {
	...
	get posBarColor(){return this.getAttribute('posBarColor')};set posBarColor(posBarColor){this.setAttribute('posBarColor',posBarColor)}
	...
	get zeroBarColor(){return this.getAttribute('zeroBarColor')};set zeroBarColor(zeroBarColor){this.setAttribute('zeroBarColor',zeroBarColor)}
