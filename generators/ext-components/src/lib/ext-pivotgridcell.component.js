...
export class ExtPivotgridcellComponent extends ExtBase {
	...
	get bodyCls(){return this.getAttribute('bodyCls')};set bodyCls(bodyCls){this.setAttribute('bodyCls',bodyCls)}
	...
	get cellCls(){return this.getAttribute('cellCls')};set cellCls(cellCls){this.setAttribute('cellCls',cellCls)}
	get cls(){return this.getAttribute('cls')};set cls(cls){this.setAttribute('cls',cls)}
	get column(){return this.getAttribute('column')};set column(column){this.setAttribute('column',column)}
	...
	get rawValue(){return this.getAttribute('rawValue')};set rawValue(rawValue){this.setAttribute('rawValue',rawValue)}
  ...
  constructor() {
    super()
    this.METHODS = ExtPivotgridcellComponent.METHODS()
    this.XTYPE = ExtPivotgridcellComponent.XTYPE()
    //this.PROPERTIES = ExtPivotgridcellComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtPivotgridcellComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtPivotgridcellComponent.EVENTS()
  }
