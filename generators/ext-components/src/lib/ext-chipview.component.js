(function () {
class ExtChipview extends ExtBase {
	...
	get closableField(){return this.getAttribute('closableField')};set closableField(closableField){this.setAttribute('closableField',closableField)}
	get closeHandler(){return this.getAttribute('closeHandler')};set closeHandler(closeHandler){this.setAttribute('closeHandler',closeHandler)}
	...
	get iconClsField(){return this.getAttribute('iconClsField')};set iconClsField(iconClsField){this.setAttribute('iconClsField',iconClsField)}
	get iconField(){return this.getAttribute('iconField')};set iconField(iconField){this.setAttribute('iconField',iconField)}
	...
	get lastSelected(){return this.getAttribute('lastSelected')};set lastSelected(lastSelected){this.setAttribute('lastSelected',lastSelected)}
	...
	get selected(){return this.getAttribute('selected')};set selected(selected){this.setAttribute('selected',selected)}
