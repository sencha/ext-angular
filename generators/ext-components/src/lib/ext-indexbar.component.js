(function () {
class ExtIndexbar extends ExtBase {
	...
	get dynamic(){return this.getAttribute('dynamic')};set dynamic(dynamic){this.setAttribute('dynamic',dynamic)}
	...
	get letters(){return this.getAttribute('letters')};set letters(letters){this.setAttribute('letters',letters)}
	get listeners(){return this.getAttribute('listeners')};set listeners(listeners){this.setAttribute('listeners',listeners)}
	get listPrefix(){return this.getAttribute('listPrefix')};set listPrefix(listPrefix){this.setAttribute('listPrefix',listPrefix)}
