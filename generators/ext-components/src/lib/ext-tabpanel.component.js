(function () {
class ExtTabpanel extends ExtBase {
	...
	get scroll(){return this.getAttribute('scroll')};set scroll(scroll){this.setAttribute('scroll',scroll)}
	...
	get tabBar(){return this.getAttribute('tabBar')};set tabBar(tabBar){this.setAttribute('tabBar',tabBar)}
	get tabBarPosition(){return this.getAttribute('tabBarPosition')};set tabBarPosition(tabBarPosition){this.setAttribute('tabBarPosition',tabBarPosition)}
