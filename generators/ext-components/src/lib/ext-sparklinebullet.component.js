(function () {
class ExtSparklinebullet extends ExtBase {
	...
	get base(){return this.getAttribute('base')};set base(base){this.setAttribute('base',base)}
	...
	get performanceColor(){return this.getAttribute('performanceColor')};set performanceColor(performanceColor){this.setAttribute('performanceColor',performanceColor)}
	...
	get rangeColors(){return this.getAttribute('rangeColors')};set rangeColors(rangeColors){this.setAttribute('rangeColors',rangeColors)}
	...
	get targetWidth(){return this.getAttribute('targetWidth')};set targetWidth(targetWidth){this.setAttribute('targetWidth',targetWidth)}
