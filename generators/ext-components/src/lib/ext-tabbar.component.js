...
export class ExtTabbarComponent extends ExtBase {
	...
	get animateIndicator(){return this.getAttribute('animateIndicator')};set animateIndicator(animateIndicator){this.setAttribute('animateIndicator',animateIndicator)}
	...
	get defaultTabUI(){return this.getAttribute('defaultTabUI')};set defaultTabUI(defaultTabUI){this.setAttribute('defaultTabUI',defaultTabUI)}
