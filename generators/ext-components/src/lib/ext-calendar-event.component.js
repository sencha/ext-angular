(function () {
class ExtCalendar_event extends ExtBase {
	...
	get defaultTitle(){return this.getAttribute('defaultTitle')};set defaultTitle(defaultTitle){this.setAttribute('defaultTitle',defaultTitle)}
	...
	get endDate(){return this.getAttribute('endDate')};set endDate(endDate){this.setAttribute('endDate',endDate)}
	...
	get model(){return this.getAttribute('model')};set model(model){this.setAttribute('model',model)}
	...
	get palette(){return this.getAttribute('palette')};set palette(palette){this.setAttribute('palette',palette)}
	...
	get resize(){return this.getAttribute('resize')};set resize(resize){this.setAttribute('resize',resize)}
	...
	get startDate(){return this.getAttribute('startDate')};set startDate(startDate){this.setAttribute('startDate',startDate)}
	...
	static XTYPE() {return 'calendar_event'}
