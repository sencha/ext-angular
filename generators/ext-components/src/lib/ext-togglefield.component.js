(function () {
class ExtTogglefield extends ExtBase {
	...
	get inactiveLabel(){return this.getAttribute('inactiveLabel')};set inactiveLabel(inactiveLabel){this.setAttribute('inactiveLabel',inactiveLabel)}
