...
export class ExtD3_packComponent extends ExtBase {
	...
	get clipText(){return this.getAttribute('clipText')};set clipText(clipText){this.setAttribute('clipText',clipText)}
