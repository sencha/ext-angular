(function () {
class ExtPivotheatmap extends ExtBase {
	...
	get defaultFormatter(){return this.getAttribute('defaultFormatter')};set defaultFormatter(defaultFormatter){this.setAttribute('defaultFormatter',defaultFormatter)}
	...
	get labels(){return this.getAttribute('labels')};set labels(labels){this.setAttribute('labels',labels)}
	...
	get tiles(){return this.getAttribute('tiles')};set tiles(tiles){this.setAttribute('tiles',tiles)}
	...
	get xAxis(){return this.getAttribute('xAxis')};set xAxis(xAxis){this.setAttribute('xAxis',xAxis)}
	...
	get yAxis(){return this.getAttribute('yAxis')};set yAxis(yAxis){this.setAttribute('yAxis',yAxis)}
