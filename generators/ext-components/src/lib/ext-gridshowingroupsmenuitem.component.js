...
export class ExtGridshowingroupsmenuitemComponent extends ExtBase {
	...
	get checkChangeDisabled(){return this.getAttribute('checkChangeDisabled')};set checkChangeDisabled(checkChangeDisabled){this.setAttribute('checkChangeDisabled',checkChangeDisabled)}
	get checked(){return this.getAttribute('checked')};set checked(checked){this.setAttribute('checked',checked)}
	get checkHandler(){return this.getAttribute('checkHandler')};set checkHandler(checkHandler){this.setAttribute('checkHandler',checkHandler)}
	get clickHideDelay(){return this.getAttribute('clickHideDelay')};set clickHideDelay(clickHideDelay){this.setAttribute('clickHideDelay',clickHideDelay)}
	...
	get hideOnClick(){return this.getAttribute('hideOnClick')};set hideOnClick(hideOnClick){this.setAttribute('hideOnClick',hideOnClick)}
	...
	get href(){return this.getAttribute('href')};set href(href){this.setAttribute('href',href)}
	...
	get menuAlign(){return this.getAttribute('menuAlign')};set menuAlign(menuAlign){this.setAttribute('menuAlign',menuAlign)}
	get menuExpandDelay(){return this.getAttribute('menuExpandDelay')};set menuExpandDelay(menuExpandDelay){this.setAttribute('menuExpandDelay',menuExpandDelay)}
	get menuHideDelay(){return this.getAttribute('menuHideDelay')};set menuHideDelay(menuHideDelay){this.setAttribute('menuHideDelay',menuHideDelay)}
	...
	get submenuText(){return this.getAttribute('submenuText')};set submenuText(submenuText){this.setAttribute('submenuText',submenuText)}
  ...
  constructor() {
    super()
    this.METHODS = ExtGridshowingroupsmenuitemComponent.METHODS()
    this.XTYPE = ExtGridshowingroupsmenuitemComponent.XTYPE()
    //this.PROPERTIES = ExtGridshowingroupsmenuitemComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtGridshowingroupsmenuitemComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtGridshowingroupsmenuitemComponent.EVENTS()
  }
