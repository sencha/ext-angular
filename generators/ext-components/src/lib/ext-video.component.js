(function () {
class ExtVideo extends ExtBase {
	...
	get autoPause(){return this.getAttribute('autoPause')};set autoPause(autoPause){this.setAttribute('autoPause',autoPause)}
	get autoResume(){return this.getAttribute('autoResume')};set autoResume(autoResume){this.setAttribute('autoResume',autoResume)}
	...
	get controls(){return this.getAttribute('controls')};set controls(controls){this.setAttribute('controls',controls)}
	...
	get enableControls(){return this.getAttribute('enableControls')};set enableControls(enableControls){this.setAttribute('enableControls',enableControls)}
	...
	get loop(){return this.getAttribute('loop')};set loop(loop){this.setAttribute('loop',loop)}
	...
	get media(){return this.getAttribute('media')};set media(media){this.setAttribute('media',media)}
	...
	get muted(){return this.getAttribute('muted')};set muted(muted){this.setAttribute('muted',muted)}
	...
	get posterUrl(){return this.getAttribute('posterUrl')};set posterUrl(posterUrl){this.setAttribute('posterUrl',posterUrl)}
	get preload(){return this.getAttribute('preload')};set preload(preload){this.setAttribute('preload',preload)}
	...
	get showPosterOnPause(){return this.getAttribute('showPosterOnPause')};set showPosterOnPause(showPosterOnPause){this.setAttribute('showPosterOnPause',showPosterOnPause)}
	...
	get volume(){return this.getAttribute('volume')};set volume(volume){this.setAttribute('volume',volume)}
