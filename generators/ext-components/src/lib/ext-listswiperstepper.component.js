(function () {
class ExtListswiperstepper extends ExtBase {
	...
	get state(){return this.getAttribute('state')};set state(state){this.setAttribute('state',state)}
	...
	get step(){return this.getAttribute('step')};set step(step){this.setAttribute('step',step)}
	...
	get translationTarget(){return this.getAttribute('translationTarget')};set translationTarget(translationTarget){this.setAttribute('translationTarget',translationTarget)}
	...
	get undo(){return this.getAttribute('undo')};set undo(undo){this.setAttribute('undo',undo)}
