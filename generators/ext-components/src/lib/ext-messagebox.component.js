(function () {
class ExtMessagebox extends ExtBase {
	...
	get constrainDrag(){return this.getAttribute('constrainDrag')};set constrainDrag(constrainDrag){this.setAttribute('constrainDrag',constrainDrag)}
	...
	get defaultTextHeight(){return this.getAttribute('defaultTextHeight')};set defaultTextHeight(defaultTextHeight){this.setAttribute('defaultTextHeight',defaultTextHeight)}
	...
	get dismissAction(){return this.getAttribute('dismissAction')};set dismissAction(dismissAction){this.setAttribute('dismissAction',dismissAction)}
	get dismissHandler(){return this.getAttribute('dismissHandler')};set dismissHandler(dismissHandler){this.setAttribute('dismissHandler',dismissHandler)}
	...
	get maskTapHandler(){return this.getAttribute('maskTapHandler')};set maskTapHandler(maskTapHandler){this.setAttribute('maskTapHandler',maskTapHandler)}
	get maxHeight(){return this.getAttribute('maxHeight')};set maxHeight(maxHeight){this.setAttribute('maxHeight',maxHeight)}
	get maximizable(){return this.getAttribute('maximizable')};set maximizable(maximizable){this.setAttribute('maximizable',maximizable)}
	get maximizeAnimation(){return this.getAttribute('maximizeAnimation')};set maximizeAnimation(maximizeAnimation){this.setAttribute('maximizeAnimation',maximizeAnimation)}
	get maximized(){return this.getAttribute('maximized')};set maximized(maximized){this.setAttribute('maximized',maximized)}
	get maximizeProxy(){return this.getAttribute('maximizeProxy')};set maximizeProxy(maximizeProxy){this.setAttribute('maximizeProxy',maximizeProxy)}
	get maximizeTool(){return this.getAttribute('maximizeTool')};set maximizeTool(maximizeTool){this.setAttribute('maximizeTool',maximizeTool)}
	get maxWidth(){return this.getAttribute('maxWidth')};set maxWidth(maxWidth){this.setAttribute('maxWidth',maxWidth)}
	get message(){return this.getAttribute('message')};set message(message){this.setAttribute('message',message)}
	...
	get msg(){return this.getAttribute('msg')};set msg(msg){this.setAttribute('msg',msg)}
	...
	get prompt(){return this.getAttribute('prompt')};set prompt(prompt){this.setAttribute('prompt',prompt)}
	...
	get restorable(){return this.getAttribute('restorable')};set restorable(restorable){this.setAttribute('restorable',restorable)}
	get restoreAnimation(){return this.getAttribute('restoreAnimation')};set restoreAnimation(restoreAnimation){this.setAttribute('restoreAnimation',restoreAnimation)}
	get restoreTool(){return this.getAttribute('restoreTool')};set restoreTool(restoreTool){this.setAttribute('restoreTool',restoreTool)}
