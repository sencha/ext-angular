...
class ExtComboboxfield extends ExtBase {
	...
	get anyMatch(){return this.getAttribute('anyMatch')};set anyMatch(anyMatch){this.setAttribute('anyMatch',anyMatch)}
	...
	get autoCapitalize(){return this.getAttribute('autoCapitalize')};set autoCapitalize(autoCapitalize){this.setAttribute('autoCapitalize',autoCapitalize)}
	get autoComplete(){return this.getAttribute('autoComplete')};set autoComplete(autoComplete){this.setAttribute('autoComplete',autoComplete)}
	get autoCorrect(){return this.getAttribute('autoCorrect')};set autoCorrect(autoCorrect){this.setAttribute('autoCorrect',autoCorrect)}
	get autoFitErrors(){return this.getAttribute('autoFitErrors')};set autoFitErrors(autoFitErrors){this.setAttribute('autoFitErrors',autoFitErrors)}
	get autoFocus(){return this.getAttribute('autoFocus')};set autoFocus(autoFocus){this.setAttribute('autoFocus',autoFocus)}
	get autoFocusLast(){return this.getAttribute('autoFocusLast')};set autoFocusLast(autoFocusLast){this.setAttribute('autoFocusLast',autoFocusLast)}
	get autoHideInputMask(){return this.getAttribute('autoHideInputMask')};set autoHideInputMask(autoHideInputMask){this.setAttribute('autoHideInputMask',autoHideInputMask)}
	get autoLoadOnValue(){return this.getAttribute('autoLoadOnValue')};set autoLoadOnValue(autoLoadOnValue){this.setAttribute('autoLoadOnValue',autoLoadOnValue)}
	get autoSelect(){return this.getAttribute('autoSelect')};set autoSelect(autoSelect){this.setAttribute('autoSelect',autoSelect)}
	get axisLock(){return this.getAttribute('axisLock')};set axisLock(axisLock){this.setAttribute('axisLock',axisLock)}
	get badFormatMessage(){return this.getAttribute('badFormatMessage')};set badFormatMessage(badFormatMessage){this.setAttribute('badFormatMessage',badFormatMessage)}
	get bind(){return this.getAttribute('bind')};set bind(bind){this.setAttribute('bind',bind)}
	get bodyAlign(){return this.getAttribute('bodyAlign')};set bodyAlign(bodyAlign){this.setAttribute('bodyAlign',bodyAlign)}
	...
	get caseSensitive(){return this.getAttribute('caseSensitive')};set caseSensitive(caseSensitive){this.setAttribute('caseSensitive',caseSensitive)}
	get centered(){return this.getAttribute('centered')};set centered(centered){this.setAttribute('centered',centered)}
	get chipView(){return this.getAttribute('chipView')};set chipView(chipView){this.setAttribute('chipView',chipView)}
	get clearable(){return this.getAttribute('clearable')};set clearable(clearable){this.setAttribute('clearable',clearable)}
	get cls(){return this.getAttribute('cls')};set cls(cls){this.setAttribute('cls',cls)}
	get collapseOnSelect(){return this.getAttribute('collapseOnSelect')};set collapseOnSelect(collapseOnSelect){this.setAttribute('collapseOnSelect',collapseOnSelect)}
	...
	get displayField(){return this.getAttribute('displayField')};set displayField(displayField){this.setAttribute('displayField',displayField)}
	get displayTpl(){return this.getAttribute('displayTpl')};set displayTpl(displayTpl){this.setAttribute('displayTpl',displayTpl)}
	...
	get enableRegEx(){return this.getAttribute('enableRegEx')};set enableRegEx(enableRegEx){this.setAttribute('enableRegEx',enableRegEx)}
	...
	get floatedPickerAlign(){return this.getAttribute('floatedPickerAlign')};set floatedPickerAlign(floatedPickerAlign){this.setAttribute('floatedPickerAlign',floatedPickerAlign)}
	get focusCls(){return this.getAttribute('focusCls')};set focusCls(focusCls){this.setAttribute('focusCls',focusCls)}
	get focusTrap(){return this.getAttribute('focusTrap')};set focusTrap(focusTrap){this.setAttribute('focusTrap',focusTrap)}
	get forceSelection(){return this.getAttribute('forceSelection')};set forceSelection(forceSelection){this.setAttribute('forceSelection',forceSelection)}
	...
	get hiddenName(){return this.getAttribute('hiddenName')};set hiddenName(hiddenName){this.setAttribute('hiddenName',hiddenName)}
	...
	get hideTrigger(){return this.getAttribute('hideTrigger')};set hideTrigger(hideTrigger){this.setAttribute('hideTrigger',hideTrigger)}
	...
	get labelAlign(){return this.getAttribute('labelAlign')};set labelAlign(labelAlign){this.setAttribute('labelAlign',labelAlign)}
	get labelCls(){return this.getAttribute('labelCls')};set labelCls(labelCls){this.setAttribute('labelCls',labelCls)}
	get labelInPlaceholder(){return this.getAttribute('labelInPlaceholder')};set labelInPlaceholder(labelInPlaceholder){this.setAttribute('labelInPlaceholder',labelInPlaceholder)}
	get labelMinWidth(){return this.getAttribute('labelMinWidth')};set labelMinWidth(labelMinWidth){this.setAttribute('labelMinWidth',labelMinWidth)}
	get labelTextAlign(){return this.getAttribute('labelTextAlign')};set labelTextAlign(labelTextAlign){this.setAttribute('labelTextAlign',labelTextAlign)}
	get labelWidth(){return this.getAttribute('labelWidth')};set labelWidth(labelWidth){this.setAttribute('labelWidth',labelWidth)}
	get labelWrap(){return this.getAttribute('labelWrap')};set labelWrap(labelWrap){this.setAttribute('labelWrap',labelWrap)}
	...
	get matchFieldWidth(){return this.getAttribute('matchFieldWidth')};set matchFieldWidth(matchFieldWidth){this.setAttribute('matchFieldWidth',matchFieldWidth)}
	get maxHeight(){return this.getAttribute('maxHeight')};set maxHeight(maxHeight){this.setAttribute('maxHeight',maxHeight)}
	get maxLength(){return this.getAttribute('maxLength')};set maxLength(maxLength){this.setAttribute('maxLength',maxLength)}
	get maxWidth(){return this.getAttribute('maxWidth')};set maxWidth(maxWidth){this.setAttribute('maxWidth',maxWidth)}
	get minChars(){return this.getAttribute('minChars')};set minChars(minChars){this.setAttribute('minChars',minChars)}
	...
	get multiSelect(){return this.getAttribute('multiSelect')};set multiSelect(multiSelect){this.setAttribute('multiSelect',multiSelect)}
	...
	get options(){return this.getAttribute('options')};set options(options){this.setAttribute('options',options)}
	...
	get primaryFilter(){return this.getAttribute('primaryFilter')};set primaryFilter(primaryFilter){this.setAttribute('primaryFilter',primaryFilter)}
	get publishes(){return this.getAttribute('publishes')};set publishes(publishes){this.setAttribute('publishes',publishes)}
	get queryCaching(){return this.getAttribute('queryCaching')};set queryCaching(queryCaching){this.setAttribute('queryCaching',queryCaching)}
	get queryDelay(){return this.getAttribute('queryDelay')};set queryDelay(queryDelay){this.setAttribute('queryDelay',queryDelay)}
	get queryMode(){return this.getAttribute('queryMode')};set queryMode(queryMode){this.setAttribute('queryMode',queryMode)}
	get queryParam(){return this.getAttribute('queryParam')};set queryParam(queryParam){this.setAttribute('queryParam',queryParam)}
	...
	get recordCreator(){return this.getAttribute('recordCreator')};set recordCreator(recordCreator){this.setAttribute('recordCreator',recordCreator)}
	get recordCreatorScope(){return this.getAttribute('recordCreatorScope')};set recordCreatorScope(recordCreatorScope){this.setAttribute('recordCreatorScope',recordCreatorScope)}
	...
	get required(){return this.getAttribute('required')};set required(required){this.setAttribute('required',required)}
	get requiredMessage(){return this.getAttribute('requiredMessage')};set requiredMessage(requiredMessage){this.setAttribute('requiredMessage',requiredMessage)}
	...
	get selectOnTab(){return this.getAttribute('selectOnTab')};set selectOnTab(selectOnTab){this.setAttribute('selectOnTab',selectOnTab)}
	...
	get sideError(){return this.getAttribute('sideError')};set sideError(sideError){this.setAttribute('sideError',sideError)}
	...
	get titleError(){return this.getAttribute('titleError')};set titleError(titleError){this.setAttribute('titleError',titleError)}
	...
	get triggerAction(){return this.getAttribute('triggerAction')};set triggerAction(triggerAction){this.setAttribute('triggerAction',triggerAction)}
	...
	get typeAhead(){return this.getAttribute('typeAhead')};set typeAhead(typeAhead){this.setAttribute('typeAhead',typeAhead)}
	get typeAheadDelay(){return this.getAttribute('typeAheadDelay')};set typeAheadDelay(typeAheadDelay){this.setAttribute('typeAheadDelay',typeAheadDelay)}
	get ui(){return this.getAttribute('ui')};set ui(ui){this.setAttribute('ui',ui)}
	get underError(){return this.getAttribute('underError')};set underError(underError){this.setAttribute('underError',underError)}
	...
	get validateDisabled(){return this.getAttribute('validateDisabled')};set validateDisabled(validateDisabled){this.setAttribute('validateDisabled',validateDisabled)}
	get validationMessage(){return this.getAttribute('validationMessage')};set validationMessage(validationMessage){this.setAttribute('validationMessage',validationMessage)}
	get validators(){return this.getAttribute('validators')};set validators(validators){this.setAttribute('validators',validators)}
	get value(){return this.getAttribute('value')};set value(value){this.setAttribute('value',value)}
	get valueCollection(){return this.getAttribute('valueCollection')};set valueCollection(valueCollection){this.setAttribute('valueCollection',valueCollection)}
	get valueField(){return this.getAttribute('valueField')};set valueField(valueField){this.setAttribute('valueField',valueField)}
	get valueNotFoundText(){return this.getAttribute('valueNotFoundText')};set valueNotFoundText(valueNotFoundText){this.setAttribute('valueNotFoundText',valueNotFoundText)}
	...
	static XTYPE() {return 'comboboxfield'}
