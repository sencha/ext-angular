(function () {
class ExtGauge extends ExtBase {
	...
	get clockwise(){return this.getAttribute('clockwise')};set clockwise(clockwise){this.setAttribute('clockwise',clockwise)}
	...
	get needle(){return this.getAttribute('needle')};set needle(needle){this.setAttribute('needle',needle)}
	...
	get textOffset(){return this.getAttribute('textOffset')};set textOffset(textOffset){this.setAttribute('textOffset',textOffset)}
	get textTpl(){return this.getAttribute('textTpl')};set textTpl(textTpl){this.setAttribute('textTpl',textTpl)}
	...
	get trackLength(){return this.getAttribute('trackLength')};set trackLength(trackLength){this.setAttribute('trackLength',trackLength)}
	get trackStart(){return this.getAttribute('trackStart')};set trackStart(trackStart){this.setAttribute('trackStart',trackStart)}
	get trackStyle(){return this.getAttribute('trackStyle')};set trackStyle(trackStyle){this.setAttribute('trackStyle',trackStyle)}
	...
	get valueStyle(){return this.getAttribute('valueStyle')};set valueStyle(valueStyle){this.setAttribute('valueStyle',valueStyle)}
