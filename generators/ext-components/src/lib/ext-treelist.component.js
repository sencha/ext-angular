(function () {
class ExtTreelist extends ExtBase {
	...
	get floatLeafItems(){return this.getAttribute('floatLeafItems')};set floatLeafItems(floatLeafItems){this.setAttribute('floatLeafItems',floatLeafItems)}
	...
	get highlightPath(){return this.getAttribute('highlightPath')};set highlightPath(highlightPath){this.setAttribute('highlightPath',highlightPath)}
	...
	get micro(){return this.getAttribute('micro')};set micro(micro){this.setAttribute('micro',micro)}
