(function () {
class ExtTreelistitem extends ExtBase {
	...
	get iconClsProperty(){return this.getAttribute('iconClsProperty')};set iconClsProperty(iconClsProperty){this.setAttribute('iconClsProperty',iconClsProperty)}
	...
	get leaf(){return this.getAttribute('leaf')};set leaf(leaf){this.setAttribute('leaf',leaf)}
	get listeners(){return this.getAttribute('listeners')};set listeners(listeners){this.setAttribute('listeners',listeners)}
	get loading(){return this.getAttribute('loading')};set loading(loading){this.setAttribute('loading',loading)}
	...
	get node(){return this.getAttribute('node')};set node(node){this.setAttribute('node',node)}
	get over(){return this.getAttribute('over')};set over(over){this.setAttribute('over',over)}
	get owner(){return this.getAttribute('owner')};set owner(owner){this.setAttribute('owner',owner)}
	get parentItem(){return this.getAttribute('parentItem')};set parentItem(parentItem){this.setAttribute('parentItem',parentItem)}
	...
	get rowCls(){return this.getAttribute('rowCls')};set rowCls(rowCls){this.setAttribute('rowCls',rowCls)}
	get rowClsProperty(){return this.getAttribute('rowClsProperty')};set rowClsProperty(rowClsProperty){this.setAttribute('rowClsProperty',rowClsProperty)}
	get selected(){return this.getAttribute('selected')};set selected(selected){this.setAttribute('selected',selected)}
	get selectedParent(){return this.getAttribute('selectedParent')};set selectedParent(selectedParent){this.setAttribute('selectedParent',selectedParent)}
	...
	get textProperty(){return this.getAttribute('textProperty')};set textProperty(textProperty){this.setAttribute('textProperty',textProperty)}
