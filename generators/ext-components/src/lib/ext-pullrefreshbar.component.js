(function () {
class ExtPullrefreshbar extends ExtBase {
	...
	get lastUpdated(){return this.getAttribute('lastUpdated')};set lastUpdated(lastUpdated){this.setAttribute('lastUpdated',lastUpdated)}
	get lastUpdatedDateFormat(){return this.getAttribute('lastUpdatedDateFormat')};set lastUpdatedDateFormat(lastUpdatedDateFormat){this.setAttribute('lastUpdatedDateFormat',lastUpdatedDateFormat)}
	get lastUpdatedText(){return this.getAttribute('lastUpdatedText')};set lastUpdatedText(lastUpdatedText){this.setAttribute('lastUpdatedText',lastUpdatedText)}
	...
	get loadedText(){return this.getAttribute('loadedText')};set loadedText(loadedText){this.setAttribute('loadedText',loadedText)}
	...
	get pull(){return this.getAttribute('pull')};set pull(pull){this.setAttribute('pull',pull)}
	get pullText(){return this.getAttribute('pullText')};set pullText(pullText){this.setAttribute('pullText',pullText)}
	...
	get releaseText(){return this.getAttribute('releaseText')};set releaseText(releaseText){this.setAttribute('releaseText',releaseText)}
