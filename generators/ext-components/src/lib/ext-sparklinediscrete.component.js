(function () {
class ExtSparklinediscrete extends ExtBase {
	...
	get lineHeight(){return this.getAttribute('lineHeight')};set lineHeight(lineHeight){this.setAttribute('lineHeight',lineHeight)}
	...
	get thresholdColor(){return this.getAttribute('thresholdColor')};set thresholdColor(thresholdColor){this.setAttribute('thresholdColor',thresholdColor)}
	get thresholdValue(){return this.getAttribute('thresholdValue')};set thresholdValue(thresholdValue){this.setAttribute('thresholdValue',thresholdValue)}
