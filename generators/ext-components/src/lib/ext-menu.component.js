...
class ExtMenu extends ExtBase {
	...
	get allowOtherMenus(){return this.getAttribute('allowOtherMenus')};set allowOtherMenus(allowOtherMenus){this.setAttribute('allowOtherMenus',allowOtherMenus)}
	...
	get groups(){return this.getAttribute('groups')};set groups(groups){this.setAttribute('groups',groups)}
	...
	get ignoreParentClicks(){return this.getAttribute('ignoreParentClicks')};set ignoreParentClicks(ignoreParentClicks){this.setAttribute('ignoreParentClicks',ignoreParentClicks)}
	...
	get indented(){return this.getAttribute('indented')};set indented(indented){this.setAttribute('indented',indented)}
	...
	get mouseLeaveDelay(){return this.getAttribute('mouseLeaveDelay')};set mouseLeaveDelay(mouseLeaveDelay){this.setAttribute('mouseLeaveDelay',mouseLeaveDelay)}
	...
	get separator(){return this.getAttribute('separator')};set separator(separator){this.setAttribute('separator',separator)}
