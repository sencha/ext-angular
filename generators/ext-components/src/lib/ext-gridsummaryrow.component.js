...
export class ExtGridsummaryrowComponent extends ExtBase {
	...
	get body(){return this.getAttribute('body')};set body(body){this.setAttribute('body',body)}
	...
	get defaultCellUI(){return this.getAttribute('defaultCellUI')};set defaultCellUI(defaultCellUI){this.setAttribute('defaultCellUI',defaultCellUI)}
	...
	get expandedField(){return this.getAttribute('expandedField')};set expandedField(expandedField){this.setAttribute('expandedField',expandedField)}
	...
	get stickyVisibility(){return this.getAttribute('stickyVisibility')};set stickyVisibility(stickyVisibility){this.setAttribute('stickyVisibility',stickyVisibility)}
