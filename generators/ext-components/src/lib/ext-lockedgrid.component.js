(function () {
class ExtLockedgrid extends ExtBase {
	...
	get defaultLockedRegion(){return this.getAttribute('defaultLockedRegion')};set defaultLockedRegion(defaultLockedRegion){this.setAttribute('defaultLockedRegion',defaultLockedRegion)}
	...
	get gridDefaults(){return this.getAttribute('gridDefaults')};set gridDefaults(gridDefaults){this.setAttribute('gridDefaults',gridDefaults)}
	...
	get leftGridDefaults(){return this.getAttribute('leftGridDefaults')};set leftGridDefaults(leftGridDefaults){this.setAttribute('leftGridDefaults',leftGridDefaults)}
	...
	get regions(){return this.getAttribute('regions')};set regions(regions){this.setAttribute('regions',regions)}
	...
	get rightGridDefaults(){return this.getAttribute('rightGridDefaults')};set rightGridDefaults(rightGridDefaults){this.setAttribute('rightGridDefaults',rightGridDefaults)}
