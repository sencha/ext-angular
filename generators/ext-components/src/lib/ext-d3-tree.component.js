...
export class ExtD3_treeComponent extends ExtBase {
	...
	get nodeRadius(){return this.getAttribute('nodeRadius')};set nodeRadius(nodeRadius){this.setAttribute('nodeRadius',nodeRadius)}
	get nodeSize(){return this.getAttribute('nodeSize')};set nodeSize(nodeSize){this.setAttribute('nodeSize',nodeSize)}
  ...
  constructor() {
    super()
    this.METHODS = ExtD3_tree.METHODS()
    this.XTYPE = ExtD3_tree.XTYPE()
    //this.PROPERTIES = ExtD3_tree.PROPERTIES()
    this.PROPERTIESOBJECT = ExtD3_tree.PROPERTIESOBJECT()
    this.EVENTS = ExtD3_tree.EVENTS()
  }
...
(function () {
window.customElements.define('ext-d3_tree', ExtD3_tree);
})();