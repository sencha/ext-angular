(function () {
class ExtWidgetcell extends ExtBase {
	...
	get forceWidth(){return this.getAttribute('forceWidth')};set forceWidth(forceWidth){this.setAttribute('forceWidth',forceWidth)}
	...
	get widget(){return this.getAttribute('widget')};set widget(widget){this.setAttribute('widget',widget)}
