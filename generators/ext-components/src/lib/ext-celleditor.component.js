(function () {
class ExtCelleditor extends ExtBase {
	...
	get allowBlur(){return this.getAttribute('allowBlur')};set allowBlur(allowBlur){this.setAttribute('allowBlur',allowBlur)}
	...
	get autoPin(){return this.getAttribute('autoPin')};set autoPin(autoPin){this.setAttribute('autoPin',autoPin)}
	...
	get cancelOnClear(){return this.getAttribute('cancelOnClear')};set cancelOnClear(cancelOnClear){this.setAttribute('cancelOnClear',cancelOnClear)}
	get cancelOnEsc(){return this.getAttribute('cancelOnEsc')};set cancelOnEsc(cancelOnEsc){this.setAttribute('cancelOnEsc',cancelOnEsc)}
	...
	get completeOnEnter(){return this.getAttribute('completeOnEnter')};set completeOnEnter(completeOnEnter){this.setAttribute('completeOnEnter',completeOnEnter)}
	get constrain(){return this.getAttribute('constrain')};set constrain(constrain){this.setAttribute('constrain',constrain)}
	...
	get hideEl(){return this.getAttribute('hideEl')};set hideEl(hideEl){this.setAttribute('hideEl',hideEl)}
	...
	get ignoreNoChange(){return this.getAttribute('ignoreNoChange')};set ignoreNoChange(ignoreNoChange){this.setAttribute('ignoreNoChange',ignoreNoChange)}
	...
	get matchFont(){return this.getAttribute('matchFont')};set matchFont(matchFont){this.setAttribute('matchFont',matchFont)}
	...
	get offset(){return this.getAttribute('offset')};set offset(offset){this.setAttribute('offset',offset)}
	get padding(){return this.getAttribute('padding')};set padding(padding){this.setAttribute('padding',padding)}
	get parentEl(){return this.getAttribute('parentEl')};set parentEl(parentEl){this.setAttribute('parentEl',parentEl)}
	...
	get revertInvalid(){return this.getAttribute('revertInvalid')};set revertInvalid(revertInvalid){this.setAttribute('revertInvalid',revertInvalid)}
	...
	get swallowKeys(){return this.getAttribute('swallowKeys')};set swallowKeys(swallowKeys){this.setAttribute('swallowKeys',swallowKeys)}
	...
	get updateEl(){return this.getAttribute('updateEl')};set updateEl(updateEl){this.setAttribute('updateEl',updateEl)}
