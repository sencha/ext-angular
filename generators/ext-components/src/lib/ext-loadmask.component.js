...
export class ExtLoadmaskComponent extends ExtBase {
	...
	get messageCls(){return this.getAttribute('messageCls')};set messageCls(messageCls){this.setAttribute('messageCls',messageCls)}
	...
	get transparent(){return this.getAttribute('transparent')};set transparent(transparent){this.setAttribute('transparent',transparent)}
