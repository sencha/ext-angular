...
export class ExtImgComponent extends ExtBase {
	...
	get backgroundCls(){return this.getAttribute('backgroundCls')};set backgroundCls(backgroundCls){this.setAttribute('backgroundCls',backgroundCls)}
	...
	get imageCls(){return this.getAttribute('imageCls')};set imageCls(imageCls){this.setAttribute('imageCls',imageCls)}
	...
	get src(){return this.getAttribute('src')};set src(src){this.setAttribute('src',src)}
  ...
  constructor() {
    super()
    this.METHODS = ExtImgComponent.METHODS()
    this.XTYPE = ExtImgComponent.XTYPE()
    //this.PROPERTIES = ExtImgComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtImgComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtImgComponent.EVENTS()
  }
