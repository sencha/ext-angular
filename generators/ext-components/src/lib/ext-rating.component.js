(function () {
class ExtRating extends ExtBase {
	...
	get family(){return this.getAttribute('family')};set family(family){this.setAttribute('family',family)}
	...
	get glyphs(){return this.getAttribute('glyphs')};set glyphs(glyphs){this.setAttribute('glyphs',glyphs)}
	...
	get limit(){return this.getAttribute('limit')};set limit(limit){this.setAttribute('limit',limit)}
	...
	get overStyle(){return this.getAttribute('overStyle')};set overStyle(overStyle){this.setAttribute('overStyle',overStyle)}
	...
	get rounding(){return this.getAttribute('rounding')};set rounding(rounding){this.setAttribute('rounding',rounding)}
	get scale(){return this.getAttribute('scale')};set scale(scale){this.setAttribute('scale',scale)}
	get scrollable(){return this.getAttribute('scrollable')};set scrollable(scrollable){this.setAttribute('scrollable',scrollable)}
	get selectedStyle(){return this.getAttribute('selectedStyle')};set selectedStyle(selectedStyle){this.setAttribute('selectedStyle',selectedStyle)}
	...
	get tip(){return this.getAttribute('tip')};set tip(tip){this.setAttribute('tip',tip)}
	...
	get tooltipText(){return this.getAttribute('tooltipText')};set tooltipText(tooltipText){this.setAttribute('tooltipText',tooltipText)}
	...
	get trackingValue(){return this.getAttribute('trackingValue')};set trackingValue(trackingValue){this.setAttribute('trackingValue',trackingValue)}
	get trackOver(){return this.getAttribute('trackOver')};set trackOver(trackOver){this.setAttribute('trackOver',trackOver)}
