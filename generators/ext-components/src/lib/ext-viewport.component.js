(function () {
class ExtViewport extends ExtBase {
	...
	get autoBlurInput(){return this.getAttribute('autoBlurInput')};set autoBlurInput(autoBlurInput){this.setAttribute('autoBlurInput',autoBlurInput)}
	...
	get autoMaximize(){return this.getAttribute('autoMaximize')};set autoMaximize(autoMaximize){this.setAttribute('autoMaximize',autoMaximize)}
	get autoRender(){return this.getAttribute('autoRender')};set autoRender(autoRender){this.setAttribute('autoRender',autoRender)}
	...
	get menus(){return this.getAttribute('menus')};set menus(menus){this.setAttribute('menus',menus)}
	...
	get orientation(){return this.getAttribute('orientation')};set orientation(orientation){this.setAttribute('orientation',orientation)}
	...
	get preventZooming(){return this.getAttribute('preventZooming')};set preventZooming(preventZooming){this.setAttribute('preventZooming',preventZooming)}
	...
	get swipeThreshold(){return this.getAttribute('swipeThreshold')};set swipeThreshold(swipeThreshold){this.setAttribute('swipeThreshold',swipeThreshold)}
