(function () {
class ExtPagingtoolbar extends ExtBase {
	...
	get defaultButtonUI(){return this.getAttribute('defaultButtonUI')};set defaultButtonUI(defaultButtonUI){this.setAttribute('defaultButtonUI',defaultButtonUI)}
	...
	get prevButton(){return this.getAttribute('prevButton')};set prevButton(prevButton){this.setAttribute('prevButton',prevButton)}
	...
	get sliderField(){return this.getAttribute('sliderField')};set sliderField(sliderField){this.setAttribute('sliderField',sliderField)}
	...
	get summaryComponent(){return this.getAttribute('summaryComponent')};set summaryComponent(summaryComponent){this.setAttribute('summaryComponent',summaryComponent)}
