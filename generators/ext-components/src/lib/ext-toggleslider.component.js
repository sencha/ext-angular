(function () {
class ExtToggleslider extends ExtBase {
	...
	get thumbDefaults(){return this.getAttribute('thumbDefaults')};set thumbDefaults(thumbDefaults){this.setAttribute('thumbDefaults',thumbDefaults)}
	...
	get valueIsArray(){return this.getAttribute('valueIsArray')};set valueIsArray(valueIsArray){this.setAttribute('valueIsArray',valueIsArray)}
