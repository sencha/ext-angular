(function () {
class ExtIndicator extends ExtBase {
	...
	get count(){return this.getAttribute('count')};set count(count){this.setAttribute('count',count)}
	...
	get tapMode(){return this.getAttribute('tapMode')};set tapMode(tapMode){this.setAttribute('tapMode',tapMode)}
