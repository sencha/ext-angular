...
export class ExtCalendar_dayComponent extends ExtBase {
	...
	get controlStoreRange(){return this.getAttribute('controlStoreRange')};set controlStoreRange(controlStoreRange){this.setAttribute('controlStoreRange',controlStoreRange)}
	get data(){return this.getAttribute('data')};set data(data){this.setAttribute('data',data)}
	get dayHeader(){return this.getAttribute('dayHeader')};set dayHeader(dayHeader){this.setAttribute('dayHeader',dayHeader)}
	get dayHeaderFormat(){return this.getAttribute('dayHeaderFormat')};set dayHeaderFormat(dayHeaderFormat){this.setAttribute('dayHeaderFormat',dayHeaderFormat)}
	...
	get displayOverlap(){return this.getAttribute('displayOverlap')};set displayOverlap(displayOverlap){this.setAttribute('displayOverlap',displayOverlap)}
	...
	get gestureNavigation(){return this.getAttribute('gestureNavigation')};set gestureNavigation(gestureNavigation){this.setAttribute('gestureNavigation',gestureNavigation)}
	...
	get resizeEvents(){return this.getAttribute('resizeEvents')};set resizeEvents(resizeEvents){this.setAttribute('resizeEvents',resizeEvents)}
	...
	get showNowMarker(){return this.getAttribute('showNowMarker')};set showNowMarker(showNowMarker){this.setAttribute('showNowMarker',showNowMarker)}
	...
	get startTime(){return this.getAttribute('startTime')};set startTime(startTime){this.setAttribute('startTime',startTime)}
	...
	get timeFormat(){return this.getAttribute('timeFormat')};set timeFormat(timeFormat){this.setAttribute('timeFormat',timeFormat)}
	...
	get visibleDays(){return this.getAttribute('visibleDays')};set visibleDays(visibleDays){this.setAttribute('visibleDays',visibleDays)}
  ...
  constructor() {
    super()
    this.METHODS = ExtCalendar_day.METHODS()
    this.XTYPE = ExtCalendar_day.XTYPE()
    //this.PROPERTIES = ExtCalendar_day.PROPERTIES()
    this.PROPERTIESOBJECT = ExtCalendar_day.PROPERTIESOBJECT()
    this.EVENTS = ExtCalendar_day.EVENTS()
  }
...
(function () {
window.customElements.define('ext-calendar_day', ExtCalendar_day);
})();